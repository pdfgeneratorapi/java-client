...
<a id="copyTemplate"></a>
# **copyTemplate**
> InlineObject19 copyTemplate(templateId, copyTemplateRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      InlineObject19 result = apiInstance.copyTemplate(templateId, copyTemplateRequest);
...
# **createTemplate**
> InlineObject19 createTemplate(templateDefinitionNew)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      InlineObject19 result = apiInstance.createTemplate(templateDefinitionNew);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="getTemplate"></a>
# **getTemplate**
> InlineObject19 getTemplate(templateId)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer templateId = 19375; // Integer | Template unique identifier
    try {
      InlineObject19 result = apiInstance.getTemplate(templateId);
      System.out.println(result);
    } catch (ApiException e) {
...
# **importTemplate**
> InlineObject19 importTemplate(importTemplateRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      InlineObject19 result = apiInstance.importTemplate(importTemplateRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
# **updateTemplate**
> InlineObject19 updateTemplate(templateId, templateDefinitionNew)
...
public class Example {
  public static void main(String[] args) {
    ...
    TemplateDefinitionNew templateDefinitionNew = new TemplateDefinitionNew(); // TemplateDefinitionNew | Template configuration
    try {
      InlineObject19 result = apiInstance.updateTemplate(templateId, templateDefinitionNew);
      System.out.println(result);
    } catch (ApiException e) {
