...
public class AddWatermark403Response {
  /**
   * Error description
   */
  ...
  public AddWatermark403Response() {
  }

  public AddWatermark403Response message(@javax.annotation.Nullable MessageEnum message) {
  ...
  public boolean equals(Object o) {
    ...
    AddWatermark403Response addWatermark403Response = (AddWatermark403Response) o;
    return Objects.equals(this.message, addWatermark403Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddWatermark403Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddWatermark403Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWatermark403Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddWatermark403Response is not found in the empty JSON string", AddWatermark403Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWatermark403Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddWatermark403Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddWatermark403Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddWatermark403Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddWatermark403Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddWatermark403Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AddWatermark403Response>() {
           @Override
           public void write(JsonWriter out, AddWatermark403Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddWatermark403Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddWatermark403Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddWatermark403Response
   * @throws IOException if the JSON string is invalid with respect to AddWatermark403Response
   */
  public static AddWatermark403Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddWatermark403Response.class);
  }

  /**
   * Convert an instance of AddWatermark403Response to an JSON string
   *
   * @return JSON string
   */
