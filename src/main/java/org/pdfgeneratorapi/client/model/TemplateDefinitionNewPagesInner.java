...
public class TemplateDefinitionNewPagesInner {
  ...
  public TemplateDefinitionNewPagesInner width(BigDecimal width) {
  ...
  **/
  ...
  public TemplateDefinitionNewPagesInner height(BigDecimal height) {
  ...
  **/
  ...
  public TemplateDefinitionNewPagesInner margins(TemplateDefinitionNewPagesInnerMargins margins) {
  ...
  **/
  ...
  public void setMargins(TemplateDefinitionNewPagesInnerMargins margins) {
    this.margins = margins;
  }


  public TemplateDefinitionNewPagesInner components(List<Component> components) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TemplateDefinitionNewPagesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TemplateDefinitionNewPagesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TemplateDefinitionNewPagesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateDefinitionNewPagesInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      // validate the optional field `margins`
      if (jsonObj.get("margins") != null && !jsonObj.get("margins").isJsonNull()) {
        TemplateDefinitionNewPagesInnerMargins.validateJsonObject(jsonObj.getAsJsonObject("margins"));
      }
      if (jsonObj.get("components") != null && !jsonObj.get("components").isJsonNull()) {
        ...
        if (jsonArraycomponents != null) {
          ...
          for (int i = 0; i < jsonArraycomponents.size(); i++) {
            Component.validateJsonObject(jsonArraycomponents.get(i).getAsJsonObject());
          };
        }
      }
  }
