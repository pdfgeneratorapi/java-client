...
public class GetTemplates422Response {
  ...
  public GetTemplates422Response error(@javax.annotation.Nullable ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public GetTemplates422Response status(@javax.annotation.Nullable Integer status) {
    this.status = status;
    return this;
  }
