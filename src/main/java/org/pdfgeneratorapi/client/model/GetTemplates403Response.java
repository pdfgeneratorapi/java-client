...
public class GetTemplates403Response {
  ...
  public GetTemplates403Response error(@javax.annotation.Nullable ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public GetTemplates403Response status(@javax.annotation.Nullable Integer status) {
    this.status = status;
    return this;
  }
