...
public class GetTemplates403Response {
  ...
  public GetTemplates403Response message(MessageEnum message) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, getTemplates403Response.message);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTemplates403Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetTemplates403Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetTemplates403Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTemplates403Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
