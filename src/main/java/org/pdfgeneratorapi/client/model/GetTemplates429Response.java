...
public class GetTemplates429Response {
  /**
   * Error description
   */
  ...
  public GetTemplates429Response() {
  }

  public GetTemplates429Response error(ErrorEnum error) {
  ...
  **/
  ...
  @ApiModelProperty(example = "You can make up to 5 requests per second and 120 requests per minute.", value = "Error description")
  ...
  public GetTemplates429Response status(Integer status) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "429", value = "HTTP Error code")
  ...
  public boolean equals(Object o) {
    ...
    GetTemplates429Response getTemplates429Response = (GetTemplates429Response) o;
    return Objects.equals(this.error, getTemplates429Response.error) &&
        Objects.equals(this.status, getTemplates429Response.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTemplates429Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTemplates429Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetTemplates429Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTemplates429Response is not found in the empty JSON string", GetTemplates429Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetTemplates429Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTemplates429Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTemplates429Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTemplates429Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTemplates429Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTemplates429Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTemplates429Response>() {
           @Override
           public void write(JsonWriter out, GetTemplates429Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTemplates429Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetTemplates429Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTemplates429Response
  * @throws IOException if the JSON string is invalid with respect to GetTemplates429Response
  */
  public static GetTemplates429Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTemplates429Response.class);
  }

 /**
  * Convert an instance of GetTemplates429Response to an JSON string
  *
  * @return JSON string
  */
