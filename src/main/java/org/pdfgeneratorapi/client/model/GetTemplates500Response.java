...
public class GetTemplates500Response {
  ...
  public GetTemplates500Response error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public GetTemplates500Response status(@javax.annotation.Nullable Integer status) {
    this.status = status;
    return this;
  }
