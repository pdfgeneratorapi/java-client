...
public class AddWatermark201ResponseMeta {
  ...
  public AddWatermark201ResponseMeta() {
  }

  public AddWatermark201ResponseMeta name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AddWatermark201ResponseMeta displayName(@javax.annotation.Nullable String displayName) {
  ...
  public AddWatermark201ResponseMeta encoding(@javax.annotation.Nullable String encoding) {
  ...
  public AddWatermark201ResponseMeta contentType(@javax.annotation.Nullable String contentType) {
  ...
  public AddWatermark201ResponseMeta publicId(@javax.annotation.Nullable String publicId) {
  ...
  public boolean equals(Object o) {
    ...
    AddWatermark201ResponseMeta addWatermark201ResponseMeta = (AddWatermark201ResponseMeta) o;
    return Objects.equals(this.name, addWatermark201ResponseMeta.name) &&
        Objects.equals(this.displayName, addWatermark201ResponseMeta.displayName) &&
        Objects.equals(this.encoding, addWatermark201ResponseMeta.encoding) &&
        Objects.equals(this.contentType, addWatermark201ResponseMeta.contentType) &&
        Objects.equals(this.publicId, addWatermark201ResponseMeta.publicId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddWatermark201ResponseMeta {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddWatermark201ResponseMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWatermark201ResponseMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddWatermark201ResponseMeta is not found in the empty JSON string", AddWatermark201ResponseMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWatermark201ResponseMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddWatermark201ResponseMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddWatermark201ResponseMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddWatermark201ResponseMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddWatermark201ResponseMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddWatermark201ResponseMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<AddWatermark201ResponseMeta>() {
           @Override
           public void write(JsonWriter out, AddWatermark201ResponseMeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddWatermark201ResponseMeta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddWatermark201ResponseMeta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddWatermark201ResponseMeta
   * @throws IOException if the JSON string is invalid with respect to AddWatermark201ResponseMeta
   */
  public static AddWatermark201ResponseMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddWatermark201ResponseMeta.class);
  }

  /**
   * Convert an instance of AddWatermark201ResponseMeta to an JSON string
   *
   * @return JSON string
   */
