...
import org.pdfgeneratorapi.client.model.Template;
...
public class GetTemplates200Response {
  ...
  private List<Template> response;
  ...
  **/
  ...
  public GetTemplates200Response meta(PaginationMeta meta) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, getTemplates200Response.response) &&
        Objects.equals(this.meta, getTemplates200Response.meta);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetTemplates200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        ...
        if (jsonArrayresponse != null) {
          ...
          for (int i = 0; i < jsonArrayresponse.size(); i++) {
            Template.validateJsonObject(jsonArrayresponse.get(i).getAsJsonObject());
          };
        }
      }
