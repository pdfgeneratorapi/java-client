...
public class GetTemplates200Response {
  ...
  public GetTemplates200Response response(@javax.annotation.Nullable List<Template> response) {
  ...
  public GetTemplates200Response meta(@javax.annotation.Nullable PaginationMeta meta) {
    this.meta = meta;
    return this;
  }
