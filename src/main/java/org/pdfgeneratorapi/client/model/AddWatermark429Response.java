...
public class AddWatermark429Response {
  public static final String SERIALIZED_NAME_MESSAGE = "message";
  @SerializedName(SERIALIZED_NAME_MESSAGE)
  @javax.annotation.Nullable
  private String message;

  public AddWatermark429Response() {
  }

  public AddWatermark429Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    AddWatermark429Response addWatermark429Response = (AddWatermark429Response) o;
    return Objects.equals(this.message, addWatermark429Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddWatermark429Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddWatermark429Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWatermark429Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddWatermark429Response is not found in the empty JSON string", AddWatermark429Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWatermark429Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddWatermark429Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddWatermark429Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddWatermark429Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddWatermark429Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddWatermark429Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AddWatermark429Response>() {
           @Override
           public void write(JsonWriter out, AddWatermark429Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddWatermark429Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddWatermark429Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddWatermark429Response
   * @throws IOException if the JSON string is invalid with respect to AddWatermark429Response
   */
  public static AddWatermark429Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddWatermark429Response.class);
  }

  /**
   * Convert an instance of AddWatermark429Response to an JSON string
   *
   * @return JSON string
   */
