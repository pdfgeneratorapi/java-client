...
public class GetTemplates402Response {
  ...
  public GetTemplates402Response error(@javax.annotation.Nullable ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public GetTemplates402Response status(@javax.annotation.Nullable Integer status) {
    this.status = status;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTemplates402Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTemplates402Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTemplates402Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTemplates402Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
