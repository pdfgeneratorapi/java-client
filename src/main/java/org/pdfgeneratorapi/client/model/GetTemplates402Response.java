...
public class GetTemplates402Response {
  /**
   * Error description
   */
  ...
  public GetTemplates402Response() {
  }

  public GetTemplates402Response error(ErrorEnum error) {
  ...
  **/
  ...
  public GetTemplates402Response status(Integer status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetTemplates402Response getTemplates402Response = (GetTemplates402Response) o;
    return Objects.equals(this.error, getTemplates402Response.error) &&
        Objects.equals(this.status, getTemplates402Response.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTemplates402Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTemplates402Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetTemplates402Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTemplates402Response is not found in the empty JSON string", GetTemplates402Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetTemplates402Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTemplates402Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTemplates402Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTemplates402Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTemplates402Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTemplates402Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTemplates402Response>() {
           @Override
           public void write(JsonWriter out, GetTemplates402Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTemplates402Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetTemplates402Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTemplates402Response
  * @throws IOException if the JSON string is invalid with respect to GetTemplates402Response
  */
  public static GetTemplates402Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTemplates402Response.class);
  }

 /**
  * Convert an instance of GetTemplates402Response to an JSON string
  *
  * @return JSON string
  */
