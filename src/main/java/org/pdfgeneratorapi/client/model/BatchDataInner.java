...
public class BatchDataInner {
  ...
  **/
  ...
  @ApiModelProperty(example = "52272", value = "Template id")
  ...
  public BatchDataInner data(Object data) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "{\"id\":123,\"name\":\"John Smith\",\"birthdate\":\"2000-01-01\",\"role\":\"Developer\"}", value = "")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.template, batchDataInner.template) &&
        Objects.equals(this.data, batchDataInner.data);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BatchDataInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BatchDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BatchDataInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchDataInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
