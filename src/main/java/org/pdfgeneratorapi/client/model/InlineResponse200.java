...
public class InlineResponse200 {
  ...
  public InlineResponse200 response(List<Template> response) {
    
    this.response = response;
    return this;
  }

  public InlineResponse200 addResponseItem(Template responseItem) {
    if (this.response == null) {
      this.response = new ArrayList<Template>();
    }
