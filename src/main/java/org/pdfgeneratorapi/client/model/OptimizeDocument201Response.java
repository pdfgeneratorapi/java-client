...
import org.pdfgeneratorapi.client.model.OptimizeDocument201ResponseMeta;
...
public class OptimizeDocument201Response {
  ...
  @javax.annotation.Nullable
  private OptimizeDocument201ResponseMeta meta;

  public OptimizeDocument201Response() {
  }

  public OptimizeDocument201Response response(@javax.annotation.Nullable String response) {
  ...
  public OptimizeDocument201Response meta(@javax.annotation.Nullable OptimizeDocument201ResponseMeta meta) {
    this.meta = meta;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public OptimizeDocument201ResponseMeta getMeta() {
    return meta;
  }

  public void setMeta(@javax.annotation.Nullable OptimizeDocument201ResponseMeta meta) {
    this.meta = meta;
  }
  ...
  public boolean equals(Object o) {
    ...
    OptimizeDocument201Response optimizeDocument201Response = (OptimizeDocument201Response) o;
    return Objects.equals(this.response, optimizeDocument201Response.response) &&
        Objects.equals(this.meta, optimizeDocument201Response.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class OptimizeDocument201Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OptimizeDocument201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OptimizeDocument201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OptimizeDocument201Response is not found in the empty JSON string", OptimizeDocument201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OptimizeDocument201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OptimizeDocument201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        OptimizeDocument201ResponseMeta.validateJsonElement(jsonObj.get("meta"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OptimizeDocument201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OptimizeDocument201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OptimizeDocument201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OptimizeDocument201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<OptimizeDocument201Response>() {
           @Override
           public void write(JsonWriter out, OptimizeDocument201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OptimizeDocument201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OptimizeDocument201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OptimizeDocument201Response
   * @throws IOException if the JSON string is invalid with respect to OptimizeDocument201Response
   */
  public static OptimizeDocument201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OptimizeDocument201Response.class);
  }

  /**
   * Convert an instance of OptimizeDocument201Response to an JSON string
   *
   * @return JSON string
   */
