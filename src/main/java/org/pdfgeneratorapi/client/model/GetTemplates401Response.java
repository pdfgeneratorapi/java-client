...
public class GetTemplates401Response {
  ...
  public GetTemplates401Response error(@javax.annotation.Nullable ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public GetTemplates401Response status(@javax.annotation.Nullable Integer status) {
    this.status = status;
    return this;
  }
