...
public class OpenEditor200Response {
  public static final String SERIALIZED_NAME_RESPONSE = "response";
  @SerializedName(SERIALIZED_NAME_RESPONSE)
  private String response;

  public OpenEditor200Response() {
  }

  public OpenEditor200Response response(String response) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OpenEditor200Response openEditor200Response = (OpenEditor200Response) o;
    return Objects.equals(this.response, openEditor200Response.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class OpenEditor200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OpenEditor200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OpenEditor200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OpenEditor200Response is not found in the empty JSON string", OpenEditor200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OpenEditor200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OpenEditor200Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OpenEditor200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OpenEditor200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OpenEditor200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OpenEditor200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<OpenEditor200Response>() {
           @Override
           public void write(JsonWriter out, OpenEditor200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OpenEditor200Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of OpenEditor200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OpenEditor200Response
  * @throws IOException if the JSON string is invalid with respect to OpenEditor200Response
  */
  public static OpenEditor200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OpenEditor200Response.class);
  }

 /**
  * Convert an instance of OpenEditor200Response to an JSON string
  *
  * @return JSON string
  */
