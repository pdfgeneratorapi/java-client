...
public class OpenEditor200Response {
  ...
  public OpenEditor200Response response(@javax.annotation.Nullable String response) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to OpenEditor200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OpenEditor200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OpenEditor200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OpenEditor200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
