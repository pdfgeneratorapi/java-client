...
public class AddWatermark422Response {
  ...
  public AddWatermark422Response() {
  }

  public AddWatermark422Response message(@javax.annotation.Nullable String message) {
  ...
  public AddWatermark422Response errors(@javax.annotation.Nullable Object errors) {
    this.errors = errors;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddWatermark422Response addWatermark422Response = (AddWatermark422Response) o;
    return Objects.equals(this.message, addWatermark422Response.message) &&
        Objects.equals(this.errors, addWatermark422Response.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddWatermark422Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddWatermark422Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWatermark422Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddWatermark422Response is not found in the empty JSON string", AddWatermark422Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWatermark422Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddWatermark422Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddWatermark422Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddWatermark422Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddWatermark422Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddWatermark422Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AddWatermark422Response>() {
           @Override
           public void write(JsonWriter out, AddWatermark422Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddWatermark422Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddWatermark422Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddWatermark422Response
   * @throws IOException if the JSON string is invalid with respect to AddWatermark422Response
   */
  public static AddWatermark422Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddWatermark422Response.class);
  }

  /**
   * Convert an instance of AddWatermark422Response to an JSON string
   *
   * @return JSON string
   */
