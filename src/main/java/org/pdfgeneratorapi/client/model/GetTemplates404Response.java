...
public class GetTemplates404Response {
  ...
  public GetTemplates404Response message(MessageEnum message) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, getTemplates404Response.message);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTemplates404Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetTemplates404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetTemplates404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTemplates404Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
