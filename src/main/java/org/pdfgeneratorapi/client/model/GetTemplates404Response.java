...
public class GetTemplates404Response {
  ...
  public GetTemplates404Response error(@javax.annotation.Nullable ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public GetTemplates404Response status(@javax.annotation.Nullable Integer status) {
    this.status = status;
    return this;
  }
