 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-02-22T21:11:49.567449+02:00[Europe/Tallinn]")
public class TemplateDefinitionNewPagesInnerMargins {
  ...
  public TemplateDefinitionNewPagesInnerMargins right(BigDecimal right) {
  ...
  **/
  ...
  @ApiModelProperty(example = "0.5", value = "Page or label margin from right")
  ...
  public TemplateDefinitionNewPagesInnerMargins bottom(BigDecimal bottom) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0.5", value = "Page or label margin from bottom")
  ...
  * @throws IOException if the JSON Object is invalid with respect to TemplateDefinitionNewPagesInnerMargins
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TemplateDefinitionNewPagesInnerMargins.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TemplateDefinitionNewPagesInnerMargins.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateDefinitionNewPagesInnerMargins` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
