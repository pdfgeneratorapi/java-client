...
public class MergeTemplate200ResponseMeta {
  ...
  public MergeTemplate200ResponseMeta name(String name) {
  ...
  **/
  ...
  public MergeTemplate200ResponseMeta displayName(String displayName) {
  ...
  **/
  ...
  public MergeTemplate200ResponseMeta encoding(String encoding) {
  ...
  **/
  ...
  public MergeTemplate200ResponseMeta contentType(String contentType) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to MergeTemplate200ResponseMeta
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MergeTemplate200ResponseMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MergeTemplate200ResponseMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeTemplate200ResponseMeta` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
