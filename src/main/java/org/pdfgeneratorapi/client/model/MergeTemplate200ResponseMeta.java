...
public class MergeTemplate200ResponseMeta {
  ...
  public MergeTemplate200ResponseMeta() {
  }

  public MergeTemplate200ResponseMeta name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public MergeTemplate200ResponseMeta displayName(@javax.annotation.Nullable String displayName) {
  ...
  public MergeTemplate200ResponseMeta encoding(@javax.annotation.Nullable String encoding) {
  ...
  public MergeTemplate200ResponseMeta contentType(@javax.annotation.Nullable String contentType) {
  ...
  public MergeTemplate200ResponseMeta publicId(@javax.annotation.Nullable String publicId) {
  ...
  public boolean equals(Object o) {
    ...
    MergeTemplate200ResponseMeta mergeTemplate200ResponseMeta = (MergeTemplate200ResponseMeta) o;
    return Objects.equals(this.name, mergeTemplate200ResponseMeta.name) &&
        Objects.equals(this.displayName, mergeTemplate200ResponseMeta.displayName) &&
        Objects.equals(this.encoding, mergeTemplate200ResponseMeta.encoding) &&
        Objects.equals(this.contentType, mergeTemplate200ResponseMeta.contentType) &&
        Objects.equals(this.publicId, mergeTemplate200ResponseMeta.publicId);
  }
  ...
  public String toString() {
    ...
    sb.append("class MergeTemplate200ResponseMeta {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeTemplate200ResponseMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeTemplate200ResponseMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeTemplate200ResponseMeta is not found in the empty JSON string", MergeTemplate200ResponseMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeTemplate200ResponseMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeTemplate200ResponseMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeTemplate200ResponseMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeTemplate200ResponseMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeTemplate200ResponseMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeTemplate200ResponseMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeTemplate200ResponseMeta>() {
           @Override
           public void write(JsonWriter out, MergeTemplate200ResponseMeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeTemplate200ResponseMeta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeTemplate200ResponseMeta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeTemplate200ResponseMeta
   * @throws IOException if the JSON string is invalid with respect to MergeTemplate200ResponseMeta
   */
  public static MergeTemplate200ResponseMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeTemplate200ResponseMeta.class);
  }

  /**
   * Convert an instance of MergeTemplate200ResponseMeta to an JSON string
   *
   * @return JSON string
   */
