...
public class OpenEditorRequestData extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<OpenEditorRequestData>() {
                ...
                public OpenEditorRequestData read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for OpenEditorRequestData: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public OpenEditorRequestData(List<Object> o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OpenEditorRequestData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for OpenEditorRequestData with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }
