...
public class GetDocument200ResponseMeta {
  ...
  public GetDocument200ResponseMeta() {
  }

  public GetDocument200ResponseMeta name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GetDocument200ResponseMeta displayName(@javax.annotation.Nullable String displayName) {
  ...
  public GetDocument200ResponseMeta encoding(@javax.annotation.Nullable String encoding) {
  ...
  public GetDocument200ResponseMeta contentType(@javax.annotation.Nullable String contentType) {
  ...
  public GetDocument200ResponseMeta publicId(@javax.annotation.Nullable String publicId) {
  ...
  public boolean equals(Object o) {
    ...
    GetDocument200ResponseMeta getDocument200ResponseMeta = (GetDocument200ResponseMeta) o;
    return Objects.equals(this.name, getDocument200ResponseMeta.name) &&
        Objects.equals(this.displayName, getDocument200ResponseMeta.displayName) &&
        Objects.equals(this.encoding, getDocument200ResponseMeta.encoding) &&
        Objects.equals(this.contentType, getDocument200ResponseMeta.contentType) &&
        Objects.equals(this.publicId, getDocument200ResponseMeta.publicId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDocument200ResponseMeta {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDocument200ResponseMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDocument200ResponseMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDocument200ResponseMeta is not found in the empty JSON string", GetDocument200ResponseMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDocument200ResponseMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDocument200ResponseMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDocument200ResponseMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDocument200ResponseMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDocument200ResponseMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDocument200ResponseMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDocument200ResponseMeta>() {
           @Override
           public void write(JsonWriter out, GetDocument200ResponseMeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDocument200ResponseMeta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDocument200ResponseMeta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDocument200ResponseMeta
   * @throws IOException if the JSON string is invalid with respect to GetDocument200ResponseMeta
   */
  public static GetDocument200ResponseMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDocument200ResponseMeta.class);
  }

  /**
   * Convert an instance of GetDocument200ResponseMeta to an JSON string
   *
   * @return JSON string
   */
