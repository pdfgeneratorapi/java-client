...
public class AddWatermark401Response {
  /**
   * Error description
   */
  ...
  public AddWatermark401Response() {
  }

  public AddWatermark401Response message(@javax.annotation.Nullable MessageEnum message) {
  ...
  public boolean equals(Object o) {
    ...
    AddWatermark401Response addWatermark401Response = (AddWatermark401Response) o;
    return Objects.equals(this.message, addWatermark401Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddWatermark401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddWatermark401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWatermark401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddWatermark401Response is not found in the empty JSON string", AddWatermark401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWatermark401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddWatermark401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddWatermark401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddWatermark401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddWatermark401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddWatermark401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AddWatermark401Response>() {
           @Override
           public void write(JsonWriter out, AddWatermark401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddWatermark401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddWatermark401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddWatermark401Response
   * @throws IOException if the JSON string is invalid with respect to AddWatermark401Response
   */
  public static AddWatermark401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddWatermark401Response.class);
  }

  /**
   * Convert an instance of AddWatermark401Response to an JSON string
   *
   * @return JSON string
   */
