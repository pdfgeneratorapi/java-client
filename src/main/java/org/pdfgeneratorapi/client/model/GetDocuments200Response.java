...
public class GetDocuments200Response {
  ...
  public GetDocuments200Response response(List<Document> response) {
  ...
  **/
  ...
  public GetDocuments200Response meta(PaginationMeta meta) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetDocuments200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetDocuments200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetDocuments200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDocuments200Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        ...
        if (jsonArrayresponse != null) {
          ...
          for (int i = 0; i < jsonArrayresponse.size(); i++) {
            Document.validateJsonObject(jsonArrayresponse.get(i).getAsJsonObject());
          };
        }
      }
