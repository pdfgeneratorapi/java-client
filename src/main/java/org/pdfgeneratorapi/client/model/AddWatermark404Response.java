...
public class AddWatermark404Response {
  /**
   * Error description
   */
  ...
  public AddWatermark404Response() {
  }

  public AddWatermark404Response message(@javax.annotation.Nullable MessageEnum message) {
  ...
  public boolean equals(Object o) {
    ...
    AddWatermark404Response addWatermark404Response = (AddWatermark404Response) o;
    return Objects.equals(this.message, addWatermark404Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddWatermark404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddWatermark404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWatermark404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddWatermark404Response is not found in the empty JSON string", AddWatermark404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWatermark404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddWatermark404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddWatermark404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddWatermark404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddWatermark404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddWatermark404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AddWatermark404Response>() {
           @Override
           public void write(JsonWriter out, AddWatermark404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddWatermark404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddWatermark404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddWatermark404Response
   * @throws IOException if the JSON string is invalid with respect to AddWatermark404Response
   */
  public static AddWatermark404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddWatermark404Response.class);
  }

  /**
   * Convert an instance of AddWatermark404Response to an JSON string
   *
   * @return JSON string
   */
