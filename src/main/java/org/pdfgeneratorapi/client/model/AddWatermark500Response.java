...
public class AddWatermark500Response {
  public static final String SERIALIZED_NAME_MESSAGE = "message";
  @SerializedName(SERIALIZED_NAME_MESSAGE)
  @javax.annotation.Nullable
  private String message;

  public AddWatermark500Response() {
  }

  public AddWatermark500Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    AddWatermark500Response addWatermark500Response = (AddWatermark500Response) o;
    return Objects.equals(this.message, addWatermark500Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddWatermark500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddWatermark500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWatermark500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddWatermark500Response is not found in the empty JSON string", AddWatermark500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWatermark500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddWatermark500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddWatermark500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddWatermark500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddWatermark500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddWatermark500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AddWatermark500Response>() {
           @Override
           public void write(JsonWriter out, AddWatermark500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddWatermark500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddWatermark500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddWatermark500Response
   * @throws IOException if the JSON string is invalid with respect to AddWatermark500Response
   */
  public static AddWatermark500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddWatermark500Response.class);
  }

  /**
   * Convert an instance of AddWatermark500Response to an JSON string
   *
   * @return JSON string
   */
