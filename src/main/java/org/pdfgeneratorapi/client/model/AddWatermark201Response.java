...
import org.pdfgeneratorapi.client.model.AddWatermark201ResponseMeta;
...
public class AddWatermark201Response {
  ...
  @javax.annotation.Nullable
  private AddWatermark201ResponseMeta meta;

  public AddWatermark201Response() {
  }

  public AddWatermark201Response response(@javax.annotation.Nullable String response) {
  ...
  public AddWatermark201Response meta(@javax.annotation.Nullable AddWatermark201ResponseMeta meta) {
    this.meta = meta;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AddWatermark201ResponseMeta getMeta() {
    return meta;
  }

  public void setMeta(@javax.annotation.Nullable AddWatermark201ResponseMeta meta) {
    this.meta = meta;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddWatermark201Response addWatermark201Response = (AddWatermark201Response) o;
    return Objects.equals(this.response, addWatermark201Response.response) &&
        Objects.equals(this.meta, addWatermark201Response.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddWatermark201Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddWatermark201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWatermark201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddWatermark201Response is not found in the empty JSON string", AddWatermark201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWatermark201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddWatermark201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        AddWatermark201ResponseMeta.validateJsonElement(jsonObj.get("meta"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddWatermark201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddWatermark201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddWatermark201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddWatermark201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AddWatermark201Response>() {
           @Override
           public void write(JsonWriter out, AddWatermark201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddWatermark201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddWatermark201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddWatermark201Response
   * @throws IOException if the JSON string is invalid with respect to AddWatermark201Response
   */
  public static AddWatermark201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddWatermark201Response.class);
  }

  /**
   * Convert an instance of AddWatermark201Response to an JSON string
   *
   * @return JSON string
   */
