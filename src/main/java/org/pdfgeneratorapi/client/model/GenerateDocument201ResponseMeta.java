...
public class GenerateDocument201ResponseMeta {
  ...
  public GenerateDocument201ResponseMeta() {
  }

  public GenerateDocument201ResponseMeta name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GenerateDocument201ResponseMeta displayName(@javax.annotation.Nullable String displayName) {
  ...
  public GenerateDocument201ResponseMeta encoding(@javax.annotation.Nullable String encoding) {
  ...
  public GenerateDocument201ResponseMeta contentType(@javax.annotation.Nullable String contentType) {
  ...
  public GenerateDocument201ResponseMeta publicId(@javax.annotation.Nullable String publicId) {
  ...
  public boolean equals(Object o) {
    ...
    GenerateDocument201ResponseMeta generateDocument201ResponseMeta = (GenerateDocument201ResponseMeta) o;
    return Objects.equals(this.name, generateDocument201ResponseMeta.name) &&
        Objects.equals(this.displayName, generateDocument201ResponseMeta.displayName) &&
        Objects.equals(this.encoding, generateDocument201ResponseMeta.encoding) &&
        Objects.equals(this.contentType, generateDocument201ResponseMeta.contentType) &&
        Objects.equals(this.publicId, generateDocument201ResponseMeta.publicId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, displayName, encoding, contentType, publicId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GenerateDocument201ResponseMeta {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateDocument201ResponseMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateDocument201ResponseMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateDocument201ResponseMeta is not found in the empty JSON string", GenerateDocument201ResponseMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateDocument201ResponseMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateDocument201ResponseMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateDocument201ResponseMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateDocument201ResponseMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateDocument201ResponseMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateDocument201ResponseMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateDocument201ResponseMeta>() {
           @Override
           public void write(JsonWriter out, GenerateDocument201ResponseMeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateDocument201ResponseMeta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateDocument201ResponseMeta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateDocument201ResponseMeta
   * @throws IOException if the JSON string is invalid with respect to GenerateDocument201ResponseMeta
   */
  public static GenerateDocument201ResponseMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateDocument201ResponseMeta.class);
  }

  /**
   * Convert an instance of GenerateDocument201ResponseMeta to an JSON string
   *
   * @return JSON string
   */
