...
public class GenerateDocument201ResponseMeta {
  ...
  public GenerateDocument201ResponseMeta name(String name) {
  ...
  **/
  ...
  public GenerateDocument201ResponseMeta displayName(String displayName) {
  ...
  **/
  ...
  public GenerateDocument201ResponseMeta encoding(String encoding) {
  ...
  **/
  ...
  public GenerateDocument201ResponseMeta contentType(String contentType) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenerateDocument201ResponseMeta
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenerateDocument201ResponseMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GenerateDocument201ResponseMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateDocument201ResponseMeta` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
