...
public class DeleteTemplate200Response {
  ...
  public DeleteTemplate200Response response(@javax.annotation.Nullable DeleteTemplate200ResponseResponse response) {
  ...
  public void setResponse(@javax.annotation.Nullable DeleteTemplate200ResponseResponse response) {
    this.response = response;
  }
