...
public class CopyTemplateRequest {
  ...
  public CopyTemplateRequest name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, copyTemplateRequest.name);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CopyTemplateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CopyTemplateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CopyTemplateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CopyTemplateRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
