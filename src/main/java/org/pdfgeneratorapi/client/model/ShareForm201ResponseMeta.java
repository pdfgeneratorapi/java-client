...
public class ShareForm201ResponseMeta {
  public static final String SERIALIZED_NAME_PUBLIC_ID = "public_id";
  @SerializedName(SERIALIZED_NAME_PUBLIC_ID)
  @javax.annotation.Nullable
  private String publicId;

  public ShareForm201ResponseMeta() {
  }

  public ShareForm201ResponseMeta publicId(@javax.annotation.Nullable String publicId) {
  ...
  public boolean equals(Object o) {
    ...
    ShareForm201ResponseMeta shareForm201ResponseMeta = (ShareForm201ResponseMeta) o;
    return Objects.equals(this.publicId, shareForm201ResponseMeta.publicId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShareForm201ResponseMeta {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ShareForm201ResponseMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ShareForm201ResponseMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShareForm201ResponseMeta is not found in the empty JSON string", ShareForm201ResponseMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ShareForm201ResponseMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShareForm201ResponseMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShareForm201ResponseMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShareForm201ResponseMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShareForm201ResponseMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShareForm201ResponseMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<ShareForm201ResponseMeta>() {
           @Override
           public void write(JsonWriter out, ShareForm201ResponseMeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShareForm201ResponseMeta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ShareForm201ResponseMeta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ShareForm201ResponseMeta
   * @throws IOException if the JSON string is invalid with respect to ShareForm201ResponseMeta
   */
  public static ShareForm201ResponseMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShareForm201ResponseMeta.class);
  }

  /**
   * Convert an instance of ShareForm201ResponseMeta to an JSON string
   *
   * @return JSON string
   */
