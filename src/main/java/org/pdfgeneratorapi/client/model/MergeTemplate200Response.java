...
import org.pdfgeneratorapi.client.model.MergeTemplate200ResponseMeta;
...
public class MergeTemplate200Response {
  ...
  private MergeTemplate200ResponseMeta meta;

  public MergeTemplate200Response() {
  }

  public MergeTemplate200Response response(String response) {
  ...
  **/
  ...
  public MergeTemplate200Response meta(MergeTemplate200ResponseMeta meta) {
  ...
  **/
  ...
  public MergeTemplate200ResponseMeta getMeta() {
    return meta;
  }


  public void setMeta(MergeTemplate200ResponseMeta meta) {
    this.meta = meta;
  }
  ...
  public boolean equals(Object o) {
    ...
    MergeTemplate200Response mergeTemplate200Response = (MergeTemplate200Response) o;
    return Objects.equals(this.response, mergeTemplate200Response.response) &&
        Objects.equals(this.meta, mergeTemplate200Response.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class MergeTemplate200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MergeTemplate200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MergeTemplate200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeTemplate200Response is not found in the empty JSON string", MergeTemplate200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MergeTemplate200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeTemplate200Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        MergeTemplate200ResponseMeta.validateJsonObject(jsonObj.getAsJsonObject("meta"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeTemplate200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeTemplate200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeTemplate200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeTemplate200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeTemplate200Response>() {
           @Override
           public void write(JsonWriter out, MergeTemplate200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeTemplate200Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MergeTemplate200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MergeTemplate200Response
  * @throws IOException if the JSON string is invalid with respect to MergeTemplate200Response
  */
  public static MergeTemplate200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeTemplate200Response.class);
  }

 /**
  * Convert an instance of MergeTemplate200Response to an JSON string
  *
  * @return JSON string
  */
