...
public class MergeTemplate200Response {
  ...
  public MergeTemplate200Response response(@javax.annotation.Nullable String response) {
  ...
  public MergeTemplate200Response meta(@javax.annotation.Nullable MergeTemplate200ResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public void setMeta(@javax.annotation.Nullable MergeTemplate200ResponseMeta meta) {
    this.meta = meta;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeTemplate200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeTemplate200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeTemplate200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeTemplate200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        MergeTemplate200ResponseMeta.validateJsonElement(jsonObj.get("meta"));
      }
  }
