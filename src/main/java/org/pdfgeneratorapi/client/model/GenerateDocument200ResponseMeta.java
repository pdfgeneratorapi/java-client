...
public class GenerateDocument200ResponseMeta {
  ...
  public GenerateDocument200ResponseMeta() {
  }

  public GenerateDocument200ResponseMeta name(String name) {
  ...
  **/
  ...
  public GenerateDocument200ResponseMeta displayName(String displayName) {
  ...
  **/
  ...
  public GenerateDocument200ResponseMeta encoding(String encoding) {
  ...
  **/
  ...
  public GenerateDocument200ResponseMeta contentType(String contentType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GenerateDocument200ResponseMeta generateDocument200ResponseMeta = (GenerateDocument200ResponseMeta) o;
    return Objects.equals(this.name, generateDocument200ResponseMeta.name) &&
        Objects.equals(this.displayName, generateDocument200ResponseMeta.displayName) &&
        Objects.equals(this.encoding, generateDocument200ResponseMeta.encoding) &&
        Objects.equals(this.contentType, generateDocument200ResponseMeta.contentType);
  }
  ...
  public String toString() {
    ...
    sb.append("class GenerateDocument200ResponseMeta {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenerateDocument200ResponseMeta
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenerateDocument200ResponseMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateDocument200ResponseMeta is not found in the empty JSON string", GenerateDocument200ResponseMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GenerateDocument200ResponseMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateDocument200ResponseMeta` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateDocument200ResponseMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateDocument200ResponseMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateDocument200ResponseMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateDocument200ResponseMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateDocument200ResponseMeta>() {
           @Override
           public void write(JsonWriter out, GenerateDocument200ResponseMeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateDocument200ResponseMeta read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GenerateDocument200ResponseMeta given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GenerateDocument200ResponseMeta
  * @throws IOException if the JSON string is invalid with respect to GenerateDocument200ResponseMeta
  */
  public static GenerateDocument200ResponseMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateDocument200ResponseMeta.class);
  }

 /**
  * Convert an instance of GenerateDocument200ResponseMeta to an JSON string
  *
  * @return JSON string
  */
