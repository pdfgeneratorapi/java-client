...
public class TemplateDefinitionDataSettings {
  ...
  private List<Object> filterBy = null;
  ...
  * @throws IOException if the JSON Object is invalid with respect to TemplateDefinitionDataSettings
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TemplateDefinitionDataSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TemplateDefinitionDataSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateDefinitionDataSettings` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
