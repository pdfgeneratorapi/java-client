...
public class GetWorkspaces200Response {
  ...
  public GetWorkspaces200Response response(@javax.annotation.Nullable List<Workspace> response) {
  ...
  public GetWorkspaces200Response meta(@javax.annotation.Nullable PaginationMeta meta) {
    this.meta = meta;
    return this;
  }
