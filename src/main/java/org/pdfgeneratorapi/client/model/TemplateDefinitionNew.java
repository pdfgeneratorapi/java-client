...
public class TemplateDefinitionNew {
  ...
  **/
  ...
  public TemplateDefinitionNew pages(List<TemplateDefinitionNewPagesInner> pages) {
  ...
  **/
  ...
  public TemplateDefinitionNew dataSettings(TemplateDefinitionNewDataSettings dataSettings) {
  ...
  **/
  ...
  public TemplateDefinitionNew editor(TemplateDefinitionNewEditor editor) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, tags, isDraft, layout, pages, dataSettings, editor);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TemplateDefinitionNew
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TemplateDefinitionNew.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TemplateDefinitionNew.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateDefinitionNew` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
