...
import org.pdfgeneratorapi.client.model.OptimizeDocument201ResponseMetaStats;
...
public class OptimizeDocument201ResponseMeta {
  ...
  @javax.annotation.Nullable
  private OptimizeDocument201ResponseMetaStats stats;
  ...
  public OptimizeDocument201ResponseMeta() {
  }

  public OptimizeDocument201ResponseMeta name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OptimizeDocument201ResponseMeta displayName(@javax.annotation.Nullable String displayName) {
  ...
  public OptimizeDocument201ResponseMeta encoding(@javax.annotation.Nullable String encoding) {
  ...
  public OptimizeDocument201ResponseMeta contentType(@javax.annotation.Nullable String contentType) {
  ...
  public OptimizeDocument201ResponseMeta stats(@javax.annotation.Nullable OptimizeDocument201ResponseMetaStats stats) {
    this.stats = stats;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public OptimizeDocument201ResponseMetaStats getStats() {
    return stats;
  }

  public void setStats(@javax.annotation.Nullable OptimizeDocument201ResponseMetaStats stats) {
    this.stats = stats;
  }


  public OptimizeDocument201ResponseMeta publicId(@javax.annotation.Nullable String publicId) {
  ...
  public boolean equals(Object o) {
    ...
    OptimizeDocument201ResponseMeta optimizeDocument201ResponseMeta = (OptimizeDocument201ResponseMeta) o;
    return Objects.equals(this.name, optimizeDocument201ResponseMeta.name) &&
        Objects.equals(this.displayName, optimizeDocument201ResponseMeta.displayName) &&
        Objects.equals(this.encoding, optimizeDocument201ResponseMeta.encoding) &&
        Objects.equals(this.contentType, optimizeDocument201ResponseMeta.contentType) &&
        Objects.equals(this.stats, optimizeDocument201ResponseMeta.stats) &&
        Objects.equals(this.publicId, optimizeDocument201ResponseMeta.publicId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, displayName, encoding, contentType, stats, publicId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OptimizeDocument201ResponseMeta {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OptimizeDocument201ResponseMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OptimizeDocument201ResponseMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OptimizeDocument201ResponseMeta is not found in the empty JSON string", OptimizeDocument201ResponseMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OptimizeDocument201ResponseMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OptimizeDocument201ResponseMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("stats") != null && !jsonObj.get("stats").isJsonNull()) {
        OptimizeDocument201ResponseMetaStats.validateJsonElement(jsonObj.get("stats"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OptimizeDocument201ResponseMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OptimizeDocument201ResponseMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OptimizeDocument201ResponseMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OptimizeDocument201ResponseMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<OptimizeDocument201ResponseMeta>() {
           @Override
           public void write(JsonWriter out, OptimizeDocument201ResponseMeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OptimizeDocument201ResponseMeta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OptimizeDocument201ResponseMeta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OptimizeDocument201ResponseMeta
   * @throws IOException if the JSON string is invalid with respect to OptimizeDocument201ResponseMeta
   */
  public static OptimizeDocument201ResponseMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OptimizeDocument201ResponseMeta.class);
  }

  /**
   * Convert an instance of OptimizeDocument201ResponseMeta to an JSON string
   *
   * @return JSON string
   */
