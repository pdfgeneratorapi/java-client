  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("dataSettings") != null && !jsonObj.get("dataSettings").isJsonNull()) {
        TemplateDefinitionDataSettings.validateJsonObject(jsonObj.getAsJsonObject("dataSettings"));
      }
      // validate the optional field `editor`
      if (jsonObj.get("editor") != null && !jsonObj.get("editor").isJsonNull()) {
        TemplateDefinitionEditor.validateJsonObject(jsonObj.getAsJsonObject("editor"));
      }
  }
