...
public class GetEditorUrl200Response {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetEditorUrl200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetEditorUrl200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetEditorUrl200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetEditorUrl200Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
