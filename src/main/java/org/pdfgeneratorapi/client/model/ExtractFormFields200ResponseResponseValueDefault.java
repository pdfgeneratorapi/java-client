...
public class ExtractFormFields200ResponseResponseValueDefault extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ExtractFormFields200ResponseResponseValueDefault.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ExtractFormFields200ResponseResponseValueDefault.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ExtractFormFields200ResponseResponseValueDefault' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ExtractFormFields200ResponseResponseValueDefault>() {
                @Override
                public void write(JsonWriter out, ExtractFormFields200ResponseResponseValueDefault value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: Boolean, List<String>, String");
                }

                @Override
                public ExtractFormFields200ResponseResponseValueDefault read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ExtractFormFields200ResponseResponseValueDefault ret = new ExtractFormFields200ResponseResponseValueDefault();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ExtractFormFields200ResponseResponseValueDefault: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ExtractFormFields200ResponseResponseValueDefault() {
        super("oneOf", Boolean.FALSE);
    }

    public ExtractFormFields200ResponseResponseValueDefault(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ExtractFormFields200ResponseResponseValueDefault.schemas;
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be Boolean, List<String>, String");
    }
     ...
     * Boolean, List<String>, String
     *
     * @return The actual instance (Boolean, List<String>, String)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     * @throws IOException if the JSON Element is invalid with respect to ExtractFormFields200ResponseResponseValueDefault
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for ExtractFormFields200ResponseResponseValueDefault with oneOf schemas: Boolean, List<String>, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of ExtractFormFields200ResponseResponseValueDefault given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ExtractFormFields200ResponseResponseValueDefault
     * @throws IOException if the JSON string is invalid with respect to ExtractFormFields200ResponseResponseValueDefault
     */
    public static ExtractFormFields200ResponseResponseValueDefault fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ExtractFormFields200ResponseResponseValueDefault.class);
    }

    /**
     * Convert an instance of ExtractFormFields200ResponseResponseValueDefault to an JSON string
     *
     * @return JSON string
     */
