...
public class AddWatermark402Response {
  /**
   * Error description
   */
  ...
  public AddWatermark402Response() {
  }

  public AddWatermark402Response message(@javax.annotation.Nullable MessageEnum message) {
  ...
  public boolean equals(Object o) {
    ...
    AddWatermark402Response addWatermark402Response = (AddWatermark402Response) o;
    return Objects.equals(this.message, addWatermark402Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddWatermark402Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddWatermark402Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWatermark402Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddWatermark402Response is not found in the empty JSON string", AddWatermark402Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWatermark402Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddWatermark402Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddWatermark402Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddWatermark402Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddWatermark402Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddWatermark402Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AddWatermark402Response>() {
           @Override
           public void write(JsonWriter out, AddWatermark402Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddWatermark402Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddWatermark402Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddWatermark402Response
   * @throws IOException if the JSON string is invalid with respect to AddWatermark402Response
   */
  public static AddWatermark402Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddWatermark402Response.class);
  }

  /**
   * Convert an instance of AddWatermark402Response to an JSON string
   *
   * @return JSON string
   */
