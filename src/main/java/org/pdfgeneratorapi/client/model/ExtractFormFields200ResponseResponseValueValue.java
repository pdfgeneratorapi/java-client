...
public class ExtractFormFields200ResponseResponseValueValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ExtractFormFields200ResponseResponseValueValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ExtractFormFields200ResponseResponseValueValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ExtractFormFields200ResponseResponseValueValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ExtractFormFields200ResponseResponseValueValue>() {
                @Override
                public void write(JsonWriter out, ExtractFormFields200ResponseResponseValueValue value) throws IOException {
                ...
                @Override
                public ExtractFormFields200ResponseResponseValueValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ExtractFormFields200ResponseResponseValueValue ret = new ExtractFormFields200ResponseResponseValueValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ExtractFormFields200ResponseResponseValueValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ExtractFormFields200ResponseResponseValueValue() {
        super("oneOf", Boolean.FALSE);
    }

    public ExtractFormFields200ResponseResponseValueValue(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ExtractFormFields200ResponseResponseValueValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ExtractFormFields200ResponseResponseValueValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for ExtractFormFields200ResponseResponseValueValue with oneOf schemas: Boolean, List<String>, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of ExtractFormFields200ResponseResponseValueValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ExtractFormFields200ResponseResponseValueValue
     * @throws IOException if the JSON string is invalid with respect to ExtractFormFields200ResponseResponseValueValue
     */
    public static ExtractFormFields200ResponseResponseValueValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ExtractFormFields200ResponseResponseValueValue.class);
    }

    /**
     * Convert an instance of ExtractFormFields200ResponseResponseValueValue to an JSON string
     *
     * @return JSON string
     */
