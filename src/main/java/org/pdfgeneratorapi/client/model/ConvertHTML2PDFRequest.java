...
public class ConvertHTML2PDFRequest {
  ...
  public ConvertHTML2PDFRequest content(String content) {
  ...
  **/
  ...
  @ApiModelProperty(example = "<html><title>Test</title><body><h1>Hello world</h1></body></html>", value = "HTML content")
  ...
  public ConvertHTML2PDFRequest paperSize(PaperSizeEnum paperSize) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "a4", value = "PDF page size")
  ...
  public ConvertHTML2PDFRequest orientation(OrientationEnum orientation) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "portrait", value = "")
  ...
  public ConvertHTML2PDFRequest output(OutputEnum output) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "base64", value = "Output")
  ...
  public ConvertHTML2PDFRequest filename(String filename) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Invoice 12345", value = "Document name")
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConvertHTML2PDFRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConvertHTML2PDFRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ConvertHTML2PDFRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConvertHTML2PDFRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
