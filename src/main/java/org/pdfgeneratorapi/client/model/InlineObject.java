...
import org.pdfgeneratorapi.client.model.InlineObjectResponse;
...
public class InlineObject {
  ...
  private InlineObjectResponse response;

  public InlineObject() {
  }

  public InlineObject response(@javax.annotation.Nullable InlineObjectResponse response) {
   ...
   */
  @javax.annotation.Nullable
  public InlineObjectResponse getResponse() {
    return response;
  }

  public void setResponse(@javax.annotation.Nullable InlineObjectResponse response) {
    this.response = response;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        InlineObjectResponse.validateJsonElement(jsonObj.get("response"));
      }
  }
