...
import org.pdfgeneratorapi.client.model.GenerateDocument200Response;
import org.pdfgeneratorapi.client.model.GenerateDocumentAsync200Response;
import org.pdfgeneratorapi.client.model.GenerateDocumentAsyncRequest;
import org.pdfgeneratorapi.client.model.GenerateDocumentBatchAsyncRequest;
...
public class DocumentsApi {
     ...
     */
    public GenerateDocument200Response generateDocument(GenerateDocumentRequest generateDocumentRequest) throws ApiException {
        ApiResponse<GenerateDocument200Response> localVarResp = generateDocumentWithHttpInfo(generateDocumentRequest);
     ...
     * Merges template with data and returns base64 encoded document or a public URL to a document. NB! When the public URL option is used, the document is stored for 30 days and automatically deleted.
     * @param generateDocumentRequest Request parameters, including template id, data and formats. (required)
     * @return ApiResponse&lt;GenerateDocument200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GenerateDocument200Response> generateDocumentWithHttpInfo(GenerateDocumentRequest generateDocumentRequest) throws ApiException {
        okhttp3.Call localVarCall = generateDocumentValidateBeforeCall(generateDocumentRequest, null);
        Type localVarReturnType = new TypeToken<GenerateDocument200Response>(){}.getType();
     ...
     */
    public okhttp3.Call generateDocumentAsync(GenerateDocumentRequest generateDocumentRequest, final ApiCallback<GenerateDocument200Response> _callback) throws ApiException {
    ...
    /**
     * Build call for generateDocumentAsync
     * @param generateDocumentAsyncRequest Request parameters, including template id, data and formats. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Async job response </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
        <tr><td> 402 </td><td> Account Suspended </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Not Found </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call generateDocumentAsyncCall(GenerateDocumentAsyncRequest generateDocumentAsyncRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = generateDocumentAsyncRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call generateDocumentAsyncValidateBeforeCall(GenerateDocumentAsyncRequest generateDocumentAsyncRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'generateDocumentAsyncRequest' is set
        if (generateDocumentAsyncRequest == null) {
            throw new ApiException("Missing the required parameter 'generateDocumentAsyncRequest' when calling generateDocumentAsync(Async)");
        }

        return generateDocumentAsyncCall(generateDocumentAsyncRequest, _callback);
     ...
     */
    public GenerateDocumentAsync200Response generateDocumentAsync(GenerateDocumentAsyncRequest generateDocumentAsyncRequest) throws ApiException {
        ApiResponse<GenerateDocumentAsync200Response> localVarResp = generateDocumentAsyncWithHttpInfo(generateDocumentAsyncRequest);
        return localVarResp.getData();
    }
     ...
     * Merges template with data as asynchronous job and makes POST request to callback URL defined in the request. Request uses the same format as response of synchronous generation endpoint. The job id is also added to the callback request as header PDF-API-Job-Id  *Example payload for callback URL:* &#x60;&#x60;&#x60; {   \&quot;response\&quot;: \&quot;https://us1.pdfgeneratorapi.com/share/12821/VBERi0xLjcKJeLjz9MKNyAwIG9i\&quot;,   \&quot;meta\&quot;: {     \&quot;name\&quot;: \&quot;a2bd25b8921f3dc7a440fd7f427f90a4.pdf\&quot;,     \&quot;display_name\&quot;: \&quot;a2bd25b8921f3dc7a440fd7f427f90a4\&quot;,     \&quot;encoding\&quot;: \&quot;binary\&quot;,     \&quot;content-type\&quot;: \&quot;application/pdf\&quot;   } } &#x60;&#x60;&#x60; 
     * @param generateDocumentAsyncRequest Request parameters, including template id, data and formats. (required)
     * @return ApiResponse&lt;GenerateDocumentAsync200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GenerateDocumentAsync200Response> generateDocumentAsyncWithHttpInfo(GenerateDocumentAsyncRequest generateDocumentAsyncRequest) throws ApiException {
        okhttp3.Call localVarCall = generateDocumentAsyncValidateBeforeCall(generateDocumentAsyncRequest, null);
        Type localVarReturnType = new TypeToken<GenerateDocumentAsync200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call generateDocumentAsyncAsync(GenerateDocumentAsyncRequest generateDocumentAsyncRequest, final ApiCallback<GenerateDocumentAsync200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = generateDocumentAsyncValidateBeforeCall(generateDocumentAsyncRequest, _callback);
        Type localVarReturnType = new TypeToken<GenerateDocumentAsync200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public GenerateDocument200Response generateDocumentBatch(GenerateDocumentBatchRequest generateDocumentBatchRequest) throws ApiException {
        ApiResponse<GenerateDocument200Response> localVarResp = generateDocumentBatchWithHttpInfo(generateDocumentBatchRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GenerateDocument200Response> generateDocumentBatchWithHttpInfo(GenerateDocumentBatchRequest generateDocumentBatchRequest) throws ApiException {
     ...
     */
    public okhttp3.Call generateDocumentBatchAsync(GenerateDocumentBatchRequest generateDocumentBatchRequest, final ApiCallback<GenerateDocument200Response> _callback) throws ApiException {
    ...
    /**
     * Build call for generateDocumentBatchAsync
     * @param generateDocumentBatchAsyncRequest Request parameters, including template id, data and formats. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call generateDocumentBatchAsyncCall(GenerateDocumentBatchAsyncRequest generateDocumentBatchAsyncRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = generateDocumentBatchAsyncRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call generateDocumentBatchAsyncValidateBeforeCall(GenerateDocumentBatchAsyncRequest generateDocumentBatchAsyncRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'generateDocumentBatchAsyncRequest' is set
        if (generateDocumentBatchAsyncRequest == null) {
            throw new ApiException("Missing the required parameter 'generateDocumentBatchAsyncRequest' when calling generateDocumentBatchAsync(Async)");
        }

        return generateDocumentBatchAsyncCall(generateDocumentBatchAsyncRequest, _callback);
     ...
     */
    public GenerateDocumentAsync200Response generateDocumentBatchAsync(GenerateDocumentBatchAsyncRequest generateDocumentBatchAsyncRequest) throws ApiException {
        ApiResponse<GenerateDocumentAsync200Response> localVarResp = generateDocumentBatchAsyncWithHttpInfo(generateDocumentBatchAsyncRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GenerateDocumentAsync200Response> generateDocumentBatchAsyncWithHttpInfo(GenerateDocumentBatchAsyncRequest generateDocumentBatchAsyncRequest) throws ApiException {
        okhttp3.Call localVarCall = generateDocumentBatchAsyncValidateBeforeCall(generateDocumentBatchAsyncRequest, null);
        Type localVarReturnType = new TypeToken<GenerateDocumentAsync200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call generateDocumentBatchAsyncAsync(GenerateDocumentBatchAsyncRequest generateDocumentBatchAsyncRequest, final ApiCallback<GenerateDocumentAsync200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = generateDocumentBatchAsyncValidateBeforeCall(generateDocumentBatchAsyncRequest, _callback);
        Type localVarReturnType = new TypeToken<GenerateDocumentAsync200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getDocumentsCall(String startDate, String endDate, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDocumentsValidateBeforeCall(String startDate, String endDate, final ApiCallback _callback) throws ApiException {
        return getDocumentsCall(startDate, endDate, _callback);
     ...
     */
    public GetDocuments200Response getDocuments(String startDate, String endDate) throws ApiException {
        ApiResponse<GetDocuments200Response> localVarResp = getDocumentsWithHttpInfo(startDate, endDate);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetDocuments200Response> getDocumentsWithHttpInfo(String startDate, String endDate) throws ApiException {
        okhttp3.Call localVarCall = getDocumentsValidateBeforeCall(startDate, endDate, null);
     ...
     */
    public okhttp3.Call getDocumentsAsync(String startDate, String endDate, final ApiCallback<GetDocuments200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDocumentsValidateBeforeCall(startDate, endDate, _callback);
        Type localVarReturnType = new TypeToken<GetDocuments200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
