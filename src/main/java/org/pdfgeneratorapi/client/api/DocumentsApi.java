...
import org.pdfgeneratorapi.client.model.GetDocument200Response;
...
public class DocumentsApi {
     ...
     */
    public okhttp3.Call deleteDocumentCall(String publicId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteDocumentValidateBeforeCall(String publicId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public void deleteDocument(String publicId) throws ApiException {
     ...
     */
    public ApiResponse<Void> deleteDocumentWithHttpInfo(String publicId) throws ApiException {
     ...
     */
    public okhttp3.Call deleteDocumentAsync(String publicId, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public AddWatermark201Response generateDocument(GenerateDocumentRequest generateDocumentRequest) throws ApiException {
        ApiResponse<AddWatermark201Response> localVarResp = generateDocumentWithHttpInfo(generateDocumentRequest);
     ...
     */
    public ApiResponse<AddWatermark201Response> generateDocumentWithHttpInfo(GenerateDocumentRequest generateDocumentRequest) throws ApiException {
     ...
     */
    public okhttp3.Call generateDocumentAsync(GenerateDocumentRequest generateDocumentRequest, final ApiCallback<AddWatermark201Response> _callback) throws ApiException {
     ...
     */
    public AddWatermark201Response generateDocumentBatch(GenerateDocumentBatchRequest generateDocumentBatchRequest) throws ApiException {
        ApiResponse<AddWatermark201Response> localVarResp = generateDocumentBatchWithHttpInfo(generateDocumentBatchRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AddWatermark201Response> generateDocumentBatchWithHttpInfo(GenerateDocumentBatchRequest generateDocumentBatchRequest) throws ApiException {
     ...
     */
    public okhttp3.Call generateDocumentBatchAsync(GenerateDocumentBatchRequest generateDocumentBatchRequest, final ApiCallback<AddWatermark201Response> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getDocumentCall(String publicId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDocumentValidateBeforeCall(String publicId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'publicId' is set
        if (publicId == null) {
     ...
     */
    public GetDocument200Response getDocument(String publicId) throws ApiException {
        ApiResponse<GetDocument200Response> localVarResp = getDocumentWithHttpInfo(publicId);
        return localVarResp.getData();
    }
     ...
     * Returns document stored in the Document Storage
     * @param publicId Resource public id (required)
     * @return ApiResponse&lt;GetDocument200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<GetDocument200Response> getDocumentWithHttpInfo(String publicId) throws ApiException {
        okhttp3.Call localVarCall = getDocumentValidateBeforeCall(publicId, null);
        Type localVarReturnType = new TypeToken<GetDocument200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getDocumentAsync(String publicId, final ApiCallback<GetDocument200Response> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getDocumentsCall(Integer templateId, String startDate, String endDate, Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDocumentsValidateBeforeCall(Integer templateId, String startDate, String endDate, Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
     ...
     */
    public GetDocuments200Response getDocuments(Integer templateId, String startDate, String endDate, Integer page, Integer perPage) throws ApiException {
        ApiResponse<GetDocuments200Response> localVarResp = getDocumentsWithHttpInfo(templateId, startDate, endDate, page, perPage);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetDocuments200Response> getDocumentsWithHttpInfo(Integer templateId, String startDate, String endDate, Integer page, Integer perPage) throws ApiException {
     ...
     */
    public okhttp3.Call getDocumentsAsync(Integer templateId, String startDate, String endDate, Integer page, Integer perPage, final ApiCallback<GetDocuments200Response> _callback) throws ApiException {
