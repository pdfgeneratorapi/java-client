...
public class TemplatesApi {
    ...
    private okhttp3.Call copyTemplateValidateBeforeCall(Integer templateId, String name, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = copyTemplateCall(templateId, name, _callback);
        return localVarCall;
     ...
     */
    public InlineResponse2001 copyTemplate(Integer templateId, String name) throws ApiException {
        ApiResponse<InlineResponse2001> localVarResp = copyTemplateWithHttpInfo(templateId, name);
     ...
     */
    public ApiResponse<InlineResponse2001> copyTemplateWithHttpInfo(Integer templateId, String name) throws ApiException {
     ...
     */
    public okhttp3.Call copyTemplateAsync(Integer templateId, String name, final ApiCallback<InlineResponse2001> _callback) throws ApiException {
    ...
    private okhttp3.Call createTemplateValidateBeforeCall(TemplateDefinitionNew templateDefinitionNew, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createTemplateCall(templateDefinitionNew, _callback);
        return localVarCall;
     ...
     */
    public InlineResponse2001 createTemplate(TemplateDefinitionNew templateDefinitionNew) throws ApiException {
        ApiResponse<InlineResponse2001> localVarResp = createTemplateWithHttpInfo(templateDefinitionNew);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InlineResponse2001> createTemplateWithHttpInfo(TemplateDefinitionNew templateDefinitionNew) throws ApiException {
     ...
     */
    public okhttp3.Call createTemplateAsync(TemplateDefinitionNew templateDefinitionNew, final ApiCallback<InlineResponse2001> _callback) throws ApiException {
     ...
     */
    public InlineResponse2002 deleteTemplate(Integer templateId) throws ApiException {
        ApiResponse<InlineResponse2002> localVarResp = deleteTemplateWithHttpInfo(templateId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InlineResponse2002> deleteTemplateWithHttpInfo(Integer templateId) throws ApiException {
     ...
     */
    public okhttp3.Call deleteTemplateAsync(Integer templateId, final ApiCallback<InlineResponse2002> _callback) throws ApiException {
    ...
    private okhttp3.Call getEditorUrlValidateBeforeCall(Integer templateId, Object body, String language, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getEditorUrlCall(templateId, body, language, _callback);
        return localVarCall;
     ...
     */
    public InlineResponse2003 getEditorUrl(Integer templateId, Object body, String language) throws ApiException {
        ApiResponse<InlineResponse2003> localVarResp = getEditorUrlWithHttpInfo(templateId, body, language);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InlineResponse2003> getEditorUrlWithHttpInfo(Integer templateId, Object body, String language) throws ApiException {
     ...
     */
    public okhttp3.Call getEditorUrlAsync(Integer templateId, Object body, String language, final ApiCallback<InlineResponse2003> _callback) throws ApiException {
     ...
     */
    public InlineResponse2001 getTemplate(Integer templateId) throws ApiException {
        ApiResponse<InlineResponse2001> localVarResp = getTemplateWithHttpInfo(templateId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InlineResponse2001> getTemplateWithHttpInfo(Integer templateId) throws ApiException {
     ...
     */
    public okhttp3.Call getTemplateAsync(Integer templateId, final ApiCallback<InlineResponse2001> _callback) throws ApiException {
     ...
     */
    public InlineResponse200 getTemplates() throws ApiException {
        ApiResponse<InlineResponse200> localVarResp = getTemplatesWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InlineResponse200> getTemplatesWithHttpInfo() throws ApiException {
     ...
     */
    public okhttp3.Call getTemplatesAsync(final ApiCallback<InlineResponse200> _callback) throws ApiException {
     ...
     * @param output Response format. (optional, default to base64)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    private okhttp3.Call mergeTemplateValidateBeforeCall(Integer templateId, Object body, String name, String format, String output, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = mergeTemplateCall(templateId, body, name, format, output, _callback);
        return localVarCall;
     ...
     */
    public InlineResponse2004 mergeTemplate(Integer templateId, Object body, String name, String format, String output) throws ApiException {
        ApiResponse<InlineResponse2004> localVarResp = mergeTemplateWithHttpInfo(templateId, body, name, format, output);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InlineResponse2004> mergeTemplateWithHttpInfo(Integer templateId, Object body, String name, String format, String output) throws ApiException {
     ...
     */
    public okhttp3.Call mergeTemplateAsync(Integer templateId, Object body, String name, String format, String output, final ApiCallback<InlineResponse2004> _callback) throws ApiException {
    ...
    /**
     * Merge multiple templates (asynchronously)
     * Allows to merge multiples template with data and returns base64 encoded document or public url to a document.
     * @param requestBody Data used to specify templates and data objects which are used to merge the template (required)
     * @param name Document name, returned in the meta data. (optional)
     * @param format Document format. The zip option will return a ZIP file with PDF files. (optional, default to pdf)
    ...
    private okhttp3.Call updateTemplateValidateBeforeCall(Integer templateId, TemplateDefinitionNew templateDefinitionNew, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateTemplateCall(templateId, templateDefinitionNew, _callback);
        return localVarCall;
     ...
     */
    public InlineResponse2001 updateTemplate(Integer templateId, TemplateDefinitionNew templateDefinitionNew) throws ApiException {
        ApiResponse<InlineResponse2001> localVarResp = updateTemplateWithHttpInfo(templateId, templateDefinitionNew);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InlineResponse2001> updateTemplateWithHttpInfo(Integer templateId, TemplateDefinitionNew templateDefinitionNew) throws ApiException {
     ...
     */
    public okhttp3.Call updateTemplateAsync(Integer templateId, TemplateDefinitionNew templateDefinitionNew, final ApiCallback<InlineResponse2001> _callback) throws ApiException {
