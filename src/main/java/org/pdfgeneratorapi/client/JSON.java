...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new org.pdfgeneratorapi.client.model.DeleteWorkspace204Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.pdfgeneratorapi.client.model.DeleteWorkspace204ResponseResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.pdfgeneratorapi.client.model.Document.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.pdfgeneratorapi.client.model.GenerateDocument201Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.pdfgeneratorapi.client.model.GenerateDocument201ResponseMeta.CustomTypeAdapterFactory());
