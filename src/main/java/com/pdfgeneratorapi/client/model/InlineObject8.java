...
public class InlineObject8 {
  ...
  public InlineObject8 response(@javax.annotation.Nullable Workspace response) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject8.response);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject8
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject8.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject8.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject8` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
