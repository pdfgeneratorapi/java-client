...
import com.pdfgeneratorapi.client.model.InlineObject11Meta;
...
public class InlineObject11 {
  ...
  public InlineObject11 response(@javax.annotation.Nullable String response) {
  ...
  public InlineObject11 meta(@javax.annotation.Nullable InlineObject11Meta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public void setMeta(@javax.annotation.Nullable InlineObject11Meta meta) {
    this.meta = meta;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject11.response) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject11
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject11.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject11.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject11` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        InlineObject11Meta.validateJsonElement(jsonObj.get("meta"));
      }
  }
