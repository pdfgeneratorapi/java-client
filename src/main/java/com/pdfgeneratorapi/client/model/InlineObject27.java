...
public class InlineObject27 {
  ...
  public InlineObject27 message(@javax.annotation.Nullable String message) {
  ...
  public InlineObject27 errors(@javax.annotation.Nullable Object errors) {
    this.errors = errors;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, inlineObject27.message) &&
        Objects.equals(this.errors, inlineObject27.errors);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject27
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject27.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject27.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject27` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
