...
public class InlineObject14ResponseValueDefault extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(InlineObject14ResponseValueDefault.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!InlineObject14ResponseValueDefault.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'InlineObject14ResponseValueDefault' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<InlineObject14ResponseValueDefault>() {
                @Override
                public void write(JsonWriter out, InlineObject14ResponseValueDefault value) throws IOException {
                ...
                @Override
                public InlineObject14ResponseValueDefault read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        InlineObject14ResponseValueDefault ret = new InlineObject14ResponseValueDefault();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for InlineObject14ResponseValueDefault: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public InlineObject14ResponseValueDefault() {
        super("oneOf", Boolean.FALSE);
    }

    public InlineObject14ResponseValueDefault(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return InlineObject14ResponseValueDefault.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to InlineObject14ResponseValueDefault
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for InlineObject14ResponseValueDefault with oneOf schemas: Boolean, List<String>, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of InlineObject14ResponseValueDefault given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of InlineObject14ResponseValueDefault
     * @throws IOException if the JSON string is invalid with respect to InlineObject14ResponseValueDefault
     */
    public static InlineObject14ResponseValueDefault fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, InlineObject14ResponseValueDefault.class);
    }

    /**
     * Convert an instance of InlineObject14ResponseValueDefault to an JSON string
     *
     * @return JSON string
     */
