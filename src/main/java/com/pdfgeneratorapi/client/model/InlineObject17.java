...
import com.pdfgeneratorapi.client.model.DocumentAction;
...
public class InlineObject17 {
  ...
  private List<DocumentAction> response = new ArrayList<>();

  public InlineObject17() {
  }

  public InlineObject17 response(@javax.annotation.Nullable List<DocumentAction> response) {
    this.response = response;
    return this;
  }

  public InlineObject17 addResponseItem(DocumentAction responseItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<DocumentAction> getResponse() {
    return response;
  }

  public void setResponse(@javax.annotation.Nullable List<DocumentAction> response) {
    this.response = response;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject17.response);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject17
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject17.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject17.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject17` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        ...
        if (jsonArrayresponse != null) {
          ...
          for (int i = 0; i < jsonArrayresponse.size(); i++) {
            DocumentAction.validateJsonElement(jsonArrayresponse.get(i));
          };
        }
      }
  }
