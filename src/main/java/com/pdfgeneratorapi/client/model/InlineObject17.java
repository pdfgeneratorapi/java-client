...
import com.pdfgeneratorapi.client.model.DocumentSignatures;
...
public class InlineObject17 {
  ...
  private DocumentSignatures response;

  public InlineObject17() {
  }

  public InlineObject17 response(@javax.annotation.Nullable DocumentSignatures response) {
   ...
   */
  @javax.annotation.Nullable
  public DocumentSignatures getResponse() {
    return response;
  }

  public void setResponse(@javax.annotation.Nullable DocumentSignatures response) {
    this.response = response;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        DocumentSignatures.validateJsonElement(jsonObj.get("response"));
      }
  }
