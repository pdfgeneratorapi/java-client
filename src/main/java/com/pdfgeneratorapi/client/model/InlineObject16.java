...
import com.pdfgeneratorapi.client.model.DocumentVersion;
...
public class InlineObject16 {
  ...
  private List<DocumentVersion> response = new ArrayList<>();

  public InlineObject16() {
  }

  public InlineObject16 response(@javax.annotation.Nullable List<DocumentVersion> response) {
    this.response = response;
    return this;
  }

  public InlineObject16 addResponseItem(DocumentVersion responseItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<DocumentVersion> getResponse() {
    return response;
  }

  public void setResponse(@javax.annotation.Nullable List<DocumentVersion> response) {
    this.response = response;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject16.response);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject16
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject16.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject16.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject16` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        ...
        if (jsonArrayresponse != null) {
          ...
          for (int i = 0; i < jsonArrayresponse.size(); i++) {
            DocumentVersion.validateJsonElement(jsonArrayresponse.get(i));
          };
        }
      }
  }
