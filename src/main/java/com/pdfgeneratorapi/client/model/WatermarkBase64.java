...
public class WatermarkBase64 {
  ...
  @javax.annotation.Nonnull
  private WatermarkFileUrlWatermark watermark;
  ...
  public WatermarkBase64() {
  }

  public WatermarkBase64 fileBase64(@javax.annotation.Nonnull String fileBase64) {
  ...
  public WatermarkBase64 watermark(@javax.annotation.Nonnull WatermarkFileUrlWatermark watermark) {
   ...
   */
  @javax.annotation.Nonnull
  public WatermarkFileUrlWatermark getWatermark() {
    return watermark;
  }

  public void setWatermark(@javax.annotation.Nonnull WatermarkFileUrlWatermark watermark) {
    this.watermark = watermark;
  }


  public WatermarkBase64 output(@javax.annotation.Nullable OutputEnum output) {
    this.output = output;
    return this;
  }
  ...
  public WatermarkBase64 name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WatermarkBase64 watermarkBase64 = (WatermarkBase64) o;
    return Objects.equals(this.fileBase64, watermarkBase64.fileBase64) &&
        Objects.equals(this.watermark, watermarkBase64.watermark) &&
        Objects.equals(this.output, watermarkBase64.output) &&
        Objects.equals(this.name, watermarkBase64.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileBase64, watermark, output, name);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("file_base64", "watermark", "output", "name"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("file_base64", "watermark"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WatermarkBase64
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatermarkBase64.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WatermarkBase64 is not found in the empty JSON string", WatermarkBase64.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WatermarkBase64.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WatermarkBase64` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WatermarkBase64.openapiRequiredFields) {
      ...
      WatermarkFileUrlWatermark.validateJsonElement(jsonObj.get("watermark"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WatermarkBase64.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WatermarkBase64' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WatermarkBase64> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WatermarkBase64.class));

       return (TypeAdapter<T>) new TypeAdapter<WatermarkBase64>() {
           @Override
           public void write(JsonWriter out, WatermarkBase64 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WatermarkBase64 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WatermarkBase64 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WatermarkBase64
   * @throws IOException if the JSON string is invalid with respect to WatermarkBase64
   */
  public static WatermarkBase64 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WatermarkBase64.class);
  }

  /**
   * Convert an instance of WatermarkBase64 to an JSON string
   *
   * @return JSON string
   */
