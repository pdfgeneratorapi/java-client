...
public class InlineObject29 {
  ...
  public InlineObject29 message(@javax.annotation.Nullable String message) {
  ...
  public InlineObject29 errors(@javax.annotation.Nullable Object errors) {
    this.errors = errors;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, inlineObject29.message) &&
        Objects.equals(this.errors, inlineObject29.errors);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject29
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject29.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject29.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject29` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
