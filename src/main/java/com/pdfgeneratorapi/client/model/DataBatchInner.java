...
public class DataBatchInner {
  ...
  public DataBatchInner() {
  }

  public DataBatchInner template(@javax.annotation.Nullable Integer template) {
  ...
  public void setTemplate(@javax.annotation.Nullable Integer template) {
    this.template = template;
  }


  public DataBatchInner data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DataBatchInner dataBatchInner = (DataBatchInner) o;
    return Objects.equals(this.template, dataBatchInner.template) &&
        Objects.equals(this.data, dataBatchInner.data);
  }

  @Override
  public int hashCode() {
    return Objects.hash(template, data);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("template", "data"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataBatchInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataBatchInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataBatchInner is not found in the empty JSON string", DataBatchInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataBatchInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataBatchInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataBatchInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataBatchInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataBatchInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataBatchInner.class));

       return (TypeAdapter<T>) new TypeAdapter<DataBatchInner>() {
           @Override
           public void write(JsonWriter out, DataBatchInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataBatchInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataBatchInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataBatchInner
   * @throws IOException if the JSON string is invalid with respect to DataBatchInner
   */
  public static DataBatchInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataBatchInner.class);
  }

  /**
   * Convert an instance of DataBatchInner to an JSON string
   *
   * @return JSON string
   */
