...
public class InlineObject1Response {
  public static final String SERIALIZED_NAME_VALID = "valid";
  @SerializedName(SERIALIZED_NAME_VALID)
  @javax.annotation.Nullable
  private Boolean valid = true;

  public InlineObject1Response() {
  }

  public InlineObject1Response valid(@javax.annotation.Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InlineObject1Response inlineObject1Response = (InlineObject1Response) o;
    return Objects.equals(this.valid, inlineObject1Response.valid);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject1Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject1Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineObject1Response is not found in the empty JSON string", InlineObject1Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject1Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject1Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineObject1Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineObject1Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineObject1Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineObject1Response.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineObject1Response>() {
           @Override
           public void write(JsonWriter out, InlineObject1Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineObject1Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineObject1Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineObject1Response
   * @throws IOException if the JSON string is invalid with respect to InlineObject1Response
   */
  public static InlineObject1Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineObject1Response.class);
  }

  /**
   * Convert an instance of InlineObject1Response to an JSON string
   *
   * @return JSON string
   */
