 ...
 */
@JsonAdapter(AsyncOutputParam.Adapter.class)
public enum AsyncOutputParam {
  ...
  public static AsyncOutputParam fromValue(String value) {
    for (AsyncOutputParam b : AsyncOutputParam.values()) {
  ...
  public static class Adapter extends TypeAdapter<AsyncOutputParam> {
    @Override
    public void write(final JsonWriter jsonWriter, final AsyncOutputParam enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AsyncOutputParam read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AsyncOutputParam.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AsyncOutputParam.fromValue(value);
  }
}
