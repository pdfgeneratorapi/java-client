...
import com.pdfgeneratorapi.client.model.PrefillParam;
...
public class StoreDocumentRequest {
  ...
  @javax.annotation.Nullable
  private OutputEnum output = OutputEnum.URL;

  public StoreDocumentRequest() {
  }

  public StoreDocumentRequest fileBase64(@javax.annotation.Nullable String fileBase64) {
  ...
  public StoreDocumentRequest fileUrl(@javax.annotation.Nullable String fileUrl) {
  ...
  public StoreDocumentRequest prefill(@javax.annotation.Nullable PrefillParam prefill) {
   ...
   */
  @javax.annotation.Nullable
  public PrefillParam getPrefill() {
    return prefill;
  }

  public void setPrefill(@javax.annotation.Nullable PrefillParam prefill) {
    this.prefill = prefill;
  }


  public StoreDocumentRequest name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public StoreDocumentRequest output(@javax.annotation.Nullable OutputEnum output) {
    this.output = output;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StoreDocumentRequest storeDocumentRequest = (StoreDocumentRequest) o;
    return Objects.equals(this.fileBase64, storeDocumentRequest.fileBase64) &&
        Objects.equals(this.fileUrl, storeDocumentRequest.fileUrl) &&
        Objects.equals(this.prefill, storeDocumentRequest.prefill) &&
        Objects.equals(this.name, storeDocumentRequest.name) &&
        Objects.equals(this.output, storeDocumentRequest.output);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileBase64, fileUrl, prefill, name, output);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("file_base64", "file_url", "prefill", "name", "output"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to StoreDocumentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StoreDocumentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StoreDocumentRequest is not found in the empty JSON string", StoreDocumentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StoreDocumentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StoreDocumentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("prefill") != null && !jsonObj.get("prefill").isJsonNull()) {
        PrefillParam.validateJsonElement(jsonObj.get("prefill"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StoreDocumentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StoreDocumentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StoreDocumentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StoreDocumentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StoreDocumentRequest>() {
           @Override
           public void write(JsonWriter out, StoreDocumentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StoreDocumentRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StoreDocumentRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StoreDocumentRequest
   * @throws IOException if the JSON string is invalid with respect to StoreDocumentRequest
   */
  public static StoreDocumentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StoreDocumentRequest.class);
  }

  /**
   * Convert an instance of StoreDocumentRequest to an JSON string
   *
   * @return JSON string
   */
