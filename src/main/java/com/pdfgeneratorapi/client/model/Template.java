...
public class Template {
  ...
  public Template id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Template owner(@javax.annotation.Nullable Boolean owner) {
    this.owner = owner;
    return this;
  }
  ...
  public Template createdAt(@javax.annotation.Nullable String createdAt) {
  ...
  public Template tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, owner, createdAt, updatedAt, tags);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "owner", "created_at", "updated_at", "tags"));
