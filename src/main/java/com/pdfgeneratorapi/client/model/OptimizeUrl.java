...
public class OptimizeUrl {
  ...
  public OptimizeUrl fileUrl(@javax.annotation.Nonnull String fileUrl) {
  ...
  public OptimizeUrl name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OptimizeUrl output(@javax.annotation.Nullable OutputEnum output) {
    this.output = output;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OptimizeUrl optimizeUrl = (OptimizeUrl) o;
    return Objects.equals(this.fileUrl, optimizeUrl.fileUrl) &&
        Objects.equals(this.name, optimizeUrl.name) &&
        Objects.equals(this.output, optimizeUrl.output);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileUrl, name, output);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("file_url", "name", "output"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to OptimizeUrl
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OptimizeUrl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OptimizeUrl is not found in the empty JSON string", OptimizeUrl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OptimizeUrl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OptimizeUrl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OptimizeUrl.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OptimizeUrl.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OptimizeUrl' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OptimizeUrl> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OptimizeUrl.class));

       return (TypeAdapter<T>) new TypeAdapter<OptimizeUrl>() {
           @Override
           public void write(JsonWriter out, OptimizeUrl value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OptimizeUrl read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OptimizeUrl given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OptimizeUrl
   * @throws IOException if the JSON string is invalid with respect to OptimizeUrl
   */
  public static OptimizeUrl fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OptimizeUrl.class);
  }

  /**
   * Convert an instance of OptimizeUrl to an JSON string
   *
   * @return JSON string
   */
