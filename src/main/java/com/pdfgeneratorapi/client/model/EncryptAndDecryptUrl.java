...
public class EncryptAndDecryptUrl {
  ...
  public EncryptAndDecryptUrl() {
  }

  public EncryptAndDecryptUrl fileUrl(@javax.annotation.Nonnull String fileUrl) {
  ...
  public EncryptAndDecryptUrl ownerPassword(@javax.annotation.Nonnull String ownerPassword) {
  ...
  public EncryptAndDecryptUrl userPassword(@javax.annotation.Nullable String userPassword) {
  ...
  public EncryptAndDecryptUrl name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public EncryptAndDecryptUrl output(@javax.annotation.Nullable OutputEnum output) {
    this.output = output;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EncryptAndDecryptUrl encryptAndDecryptUrl = (EncryptAndDecryptUrl) o;
    return Objects.equals(this.fileUrl, encryptAndDecryptUrl.fileUrl) &&
        Objects.equals(this.ownerPassword, encryptAndDecryptUrl.ownerPassword) &&
        Objects.equals(this.userPassword, encryptAndDecryptUrl.userPassword) &&
        Objects.equals(this.name, encryptAndDecryptUrl.name) &&
        Objects.equals(this.output, encryptAndDecryptUrl.output);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileUrl, ownerPassword, userPassword, name, output);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("file_url", "owner_password", "user_password", "name", "output"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("file_url", "owner_password"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EncryptAndDecryptUrl
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EncryptAndDecryptUrl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EncryptAndDecryptUrl is not found in the empty JSON string", EncryptAndDecryptUrl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EncryptAndDecryptUrl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EncryptAndDecryptUrl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EncryptAndDecryptUrl.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EncryptAndDecryptUrl.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EncryptAndDecryptUrl' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EncryptAndDecryptUrl> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EncryptAndDecryptUrl.class));

       return (TypeAdapter<T>) new TypeAdapter<EncryptAndDecryptUrl>() {
           @Override
           public void write(JsonWriter out, EncryptAndDecryptUrl value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EncryptAndDecryptUrl read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EncryptAndDecryptUrl given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EncryptAndDecryptUrl
   * @throws IOException if the JSON string is invalid with respect to EncryptAndDecryptUrl
   */
  public static EncryptAndDecryptUrl fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EncryptAndDecryptUrl.class);
  }

  /**
   * Convert an instance of EncryptAndDecryptUrl to an JSON string
   *
   * @return JSON string
   */
