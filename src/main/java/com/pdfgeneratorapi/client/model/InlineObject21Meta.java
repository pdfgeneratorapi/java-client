...
public class InlineObject21Meta {
  public static final String SERIALIZED_NAME_PUBLIC_ID = "public_id";
  @SerializedName(SERIALIZED_NAME_PUBLIC_ID)
  @javax.annotation.Nullable
  private String publicId;

  public InlineObject21Meta() {
  }

  public InlineObject21Meta publicId(@javax.annotation.Nullable String publicId) {
  ...
  public boolean equals(Object o) {
    ...
    InlineObject21Meta inlineObject21Meta = (InlineObject21Meta) o;
    return Objects.equals(this.publicId, inlineObject21Meta.publicId);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineObject21Meta {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("public_id"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject21Meta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject21Meta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineObject21Meta is not found in the empty JSON string", InlineObject21Meta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject21Meta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject21Meta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineObject21Meta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineObject21Meta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineObject21Meta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineObject21Meta.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineObject21Meta>() {
           @Override
           public void write(JsonWriter out, InlineObject21Meta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineObject21Meta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineObject21Meta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineObject21Meta
   * @throws IOException if the JSON string is invalid with respect to InlineObject21Meta
   */
  public static InlineObject21Meta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineObject21Meta.class);
  }

  /**
   * Convert an instance of InlineObject21Meta to an JSON string
   *
   * @return JSON string
   */
