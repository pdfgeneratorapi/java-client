...
import com.pdfgeneratorapi.client.model.InlineObject7Response;
...
public class InlineObject7 {
  ...
  private InlineObject7Response response;

  public InlineObject7() {
  }

  public InlineObject7 response(@javax.annotation.Nullable InlineObject7Response response) {
   ...
   */
  @javax.annotation.Nullable
  public InlineObject7Response getResponse() {
    return response;
  }

  public void setResponse(@javax.annotation.Nullable InlineObject7Response response) {
    this.response = response;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject7.response);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject7
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject7.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject7.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject7` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `response`
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        InlineObject7Response.validateJsonElement(jsonObj.get("response"));
      }
  }
