...
public class InlineObjectMeta {
  ...
  public InlineObjectMeta() {
  }

  public InlineObjectMeta encoding(@javax.annotation.Nullable String encoding) {
  ...
  public InlineObjectMeta contentType(@javax.annotation.Nullable String contentType) {
  ...
  public boolean equals(Object o) {
    ...
    InlineObjectMeta inlineObjectMeta = (InlineObjectMeta) o;
    return Objects.equals(this.encoding, inlineObjectMeta.encoding) &&
        Objects.equals(this.contentType, inlineObjectMeta.contentType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObjectMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObjectMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineObjectMeta is not found in the empty JSON string", InlineObjectMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObjectMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObjectMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineObjectMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineObjectMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineObjectMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineObjectMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineObjectMeta>() {
           @Override
           public void write(JsonWriter out, InlineObjectMeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineObjectMeta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineObjectMeta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineObjectMeta
   * @throws IOException if the JSON string is invalid with respect to InlineObjectMeta
   */
  public static InlineObjectMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineObjectMeta.class);
  }

  /**
   * Convert an instance of InlineObjectMeta to an JSON string
   *
   * @return JSON string
   */
