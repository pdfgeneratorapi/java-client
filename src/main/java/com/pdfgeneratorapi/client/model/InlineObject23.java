...
import com.pdfgeneratorapi.client.model.InlineObject23Response;
...
public class InlineObject23 {
  ...
  private InlineObject23Response response;

  public InlineObject23() {
  }

  public InlineObject23 response(@javax.annotation.Nullable InlineObject23Response response) {
   ...
   */
  @javax.annotation.Nullable
  public InlineObject23Response getResponse() {
    return response;
  }

  public void setResponse(@javax.annotation.Nullable InlineObject23Response response) {
    this.response = response;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject23.response);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject23
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject23.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject23.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject23` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `response`
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        InlineObject23Response.validateJsonElement(jsonObj.get("response"));
      }
  }
