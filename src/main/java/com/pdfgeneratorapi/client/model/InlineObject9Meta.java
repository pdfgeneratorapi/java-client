...
public class InlineObject9Meta {
  ...
  public InlineObject9Meta() {
  }

  public InlineObject9Meta name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public InlineObject9Meta displayName(@javax.annotation.Nullable String displayName) {
  ...
  public InlineObject9Meta encoding(@javax.annotation.Nullable String encoding) {
  ...
  public InlineObject9Meta contentType(@javax.annotation.Nullable String contentType) {
  ...
  public InlineObject9Meta publicId(@javax.annotation.Nullable String publicId) {
  ...
  public boolean equals(Object o) {
    ...
    InlineObject9Meta inlineObject9Meta = (InlineObject9Meta) o;
    return Objects.equals(this.name, inlineObject9Meta.name) &&
        Objects.equals(this.displayName, inlineObject9Meta.displayName) &&
        Objects.equals(this.encoding, inlineObject9Meta.encoding) &&
        Objects.equals(this.contentType, inlineObject9Meta.contentType) &&
        Objects.equals(this.publicId, inlineObject9Meta.publicId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject9Meta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject9Meta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineObject9Meta is not found in the empty JSON string", InlineObject9Meta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject9Meta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject9Meta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineObject9Meta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineObject9Meta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineObject9Meta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineObject9Meta.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineObject9Meta>() {
           @Override
           public void write(JsonWriter out, InlineObject9Meta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineObject9Meta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineObject9Meta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineObject9Meta
   * @throws IOException if the JSON string is invalid with respect to InlineObject9Meta
   */
  public static InlineObject9Meta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineObject9Meta.class);
  }

  /**
   * Convert an instance of InlineObject9Meta to an JSON string
   *
   * @return JSON string
   */
