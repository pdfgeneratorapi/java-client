...
import com.pdfgeneratorapi.client.model.InlineObject22Response;
...
public class InlineObject22 {
  ...
  private InlineObject22Response response;

  public InlineObject22() {
  }

  public InlineObject22 response(@javax.annotation.Nullable InlineObject22Response response) {
   ...
   */
  @javax.annotation.Nullable
  public InlineObject22Response getResponse() {
    return response;
  }

  public void setResponse(@javax.annotation.Nullable InlineObject22Response response) {
    this.response = response;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject22.response);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject22
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject22.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject22.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject22` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `response`
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        InlineObject22Response.validateJsonElement(jsonObj.get("response"));
      }
  }
