...
import com.pdfgeneratorapi.client.model.InlineObject20Meta;
...
public class InlineObject20 {
  ...
  @javax.annotation.Nullable
  private InlineObject20Meta meta;

  public InlineObject20() {
  }

  public InlineObject20 response(@javax.annotation.Nullable String response) {
  ...
  public InlineObject20 meta(@javax.annotation.Nullable InlineObject20Meta meta) {
    this.meta = meta;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public InlineObject20Meta getMeta() {
    return meta;
  }

  public void setMeta(@javax.annotation.Nullable InlineObject20Meta meta) {
    this.meta = meta;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject20.response) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject20
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject20.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject20.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject20` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        InlineObject20Meta.validateJsonElement(jsonObj.get("meta"));
      }
  }
