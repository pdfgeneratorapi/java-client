...
public class InlineObject25 {
  ...
  public InlineObject25 message(@javax.annotation.Nullable String message) {
  ...
  public InlineObject25 errors(@javax.annotation.Nullable Object errors) {
    this.errors = errors;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, inlineObject25.message) &&
        Objects.equals(this.errors, inlineObject25.errors);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject25
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject25.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject25.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject25` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
