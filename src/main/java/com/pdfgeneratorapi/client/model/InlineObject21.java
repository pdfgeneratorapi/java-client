...
import com.pdfgeneratorapi.client.model.InlineObject21Meta;
...
public class InlineObject21 {
  ...
  @javax.annotation.Nullable
  private InlineObject21Meta meta;

  public InlineObject21() {
  }

  public InlineObject21 response(@javax.annotation.Nullable String response) {
  ...
  public InlineObject21 meta(@javax.annotation.Nullable InlineObject21Meta meta) {
    this.meta = meta;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public InlineObject21Meta getMeta() {
    return meta;
  }

  public void setMeta(@javax.annotation.Nullable InlineObject21Meta meta) {
    this.meta = meta;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject21.response) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject21
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject21.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject21.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject21` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        InlineObject21Meta.validateJsonElement(jsonObj.get("meta"));
      }
  }
