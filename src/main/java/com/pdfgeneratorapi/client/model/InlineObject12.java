...
import com.pdfgeneratorapi.client.model.InlineObject12Meta;
...
public class InlineObject12 {
  ...
  @javax.annotation.Nullable
  private InlineObject12Meta meta;

  public InlineObject12() {
  }

  public InlineObject12 response(@javax.annotation.Nullable String response) {
  ...
  public InlineObject12 meta(@javax.annotation.Nullable InlineObject12Meta meta) {
    this.meta = meta;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public InlineObject12Meta getMeta() {
    return meta;
  }

  public void setMeta(@javax.annotation.Nullable InlineObject12Meta meta) {
    this.meta = meta;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject12.response) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject12
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject12.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject12.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject12` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        InlineObject12Meta.validateJsonElement(jsonObj.get("meta"));
      }
  }
