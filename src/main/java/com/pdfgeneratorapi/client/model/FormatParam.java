 ...
 * Document format.
 */
@JsonAdapter(FormatParam.Adapter.class)
public enum FormatParam {
  ...
  public static FormatParam fromValue(String value) {
    for (FormatParam b : FormatParam.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormatParam> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormatParam enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormatParam read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormatParam.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormatParam.fromValue(value);
  }
}
