...
public class CreateEInvoiceRequest {
  ...
  private TypeEnum type = TypeEnum.UBL;
  ...
  public CreateEInvoiceRequest() {
  }

  public CreateEInvoiceRequest data(@javax.annotation.Nonnull Object data) {
    this.data = data;
    return this;
  }
  ...
  public CreateEInvoiceRequest type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public CreateEInvoiceRequest output(@javax.annotation.Nullable OutputEnum output) {
    this.output = output;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateEInvoiceRequest createEInvoiceRequest = (CreateEInvoiceRequest) o;
    return Objects.equals(this.data, createEInvoiceRequest.data) &&
        Objects.equals(this.type, createEInvoiceRequest.type) &&
        Objects.equals(this.output, createEInvoiceRequest.output);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, type, output);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("data", "type", "output"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateEInvoiceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateEInvoiceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateEInvoiceRequest is not found in the empty JSON string", CreateEInvoiceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateEInvoiceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateEInvoiceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateEInvoiceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateEInvoiceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateEInvoiceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateEInvoiceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateEInvoiceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateEInvoiceRequest>() {
           @Override
           public void write(JsonWriter out, CreateEInvoiceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateEInvoiceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateEInvoiceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateEInvoiceRequest
   * @throws IOException if the JSON string is invalid with respect to CreateEInvoiceRequest
   */
  public static CreateEInvoiceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateEInvoiceRequest.class);
  }

  /**
   * Convert an instance of CreateEInvoiceRequest to an JSON string
   *
   * @return JSON string
   */
