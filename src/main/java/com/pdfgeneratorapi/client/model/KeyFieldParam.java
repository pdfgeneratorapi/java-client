 ...
 */
@JsonAdapter(KeyFieldParam.Adapter.class)
public enum KeyFieldParam {
  ...
  public static KeyFieldParam fromValue(String value) {
    for (KeyFieldParam b : KeyFieldParam.values()) {
  ...
  public static class Adapter extends TypeAdapter<KeyFieldParam> {
    @Override
    public void write(final JsonWriter jsonWriter, final KeyFieldParam enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public KeyFieldParam read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return KeyFieldParam.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    KeyFieldParam.fromValue(value);
  }
}
