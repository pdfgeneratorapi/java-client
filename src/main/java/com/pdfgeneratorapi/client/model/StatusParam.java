...
/**
 * Gets or Sets statusParam
 */
@JsonAdapter(StatusParam.Adapter.class)
public enum StatusParam {
  ...
  public static StatusParam fromValue(String value) {
    for (StatusParam b : StatusParam.values()) {
  ...
  public static class Adapter extends TypeAdapter<StatusParam> {
    @Override
    public void write(final JsonWriter jsonWriter, final StatusParam enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StatusParam read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StatusParam.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StatusParam.fromValue(value);
  }
}
