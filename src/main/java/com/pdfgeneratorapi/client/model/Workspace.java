...
public class Workspace {
  ...
  public Workspace id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Workspace identifier(@javax.annotation.Nullable String identifier) {
  ...
  public Workspace isMasterWorkspace(@javax.annotation.Nullable Boolean isMasterWorkspace) {
  ...
  public void setIsMasterWorkspace(@javax.annotation.Nullable Boolean isMasterWorkspace) {
    this.isMasterWorkspace = isMasterWorkspace;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, identifier, isMasterWorkspace, createdAt);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "identifier", "is_master_workspace", "created_at"));
