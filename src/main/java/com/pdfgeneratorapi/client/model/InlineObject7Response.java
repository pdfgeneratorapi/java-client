...
public class InlineObject7Response {
  public static final String SERIALIZED_NAME_SUCCESS = "success";
  @SerializedName(SERIALIZED_NAME_SUCCESS)
  @javax.annotation.Nullable
  private Boolean success;

  public InlineObject7Response() {
  }

  public InlineObject7Response success(@javax.annotation.Nullable Boolean success) {
  ...
  public boolean equals(Object o) {
    ...
    InlineObject7Response inlineObject7Response = (InlineObject7Response) o;
    return Objects.equals(this.success, inlineObject7Response.success);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject7Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject7Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineObject7Response is not found in the empty JSON string", InlineObject7Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject7Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject7Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineObject7Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineObject7Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineObject7Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineObject7Response.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineObject7Response>() {
           @Override
           public void write(JsonWriter out, InlineObject7Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineObject7Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineObject7Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineObject7Response
   * @throws IOException if the JSON string is invalid with respect to InlineObject7Response
   */
  public static InlineObject7Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineObject7Response.class);
  }

  /**
   * Convert an instance of InlineObject7Response to an JSON string
   *
   * @return JSON string
   */
