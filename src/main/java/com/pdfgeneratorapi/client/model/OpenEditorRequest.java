...
import com.pdfgeneratorapi.client.model.OpenEditorRequestData;
...
public class OpenEditorRequest {
  ...
  private OpenEditorRequestData data;
  ...
  public OpenEditorRequest() {
  }

  public OpenEditorRequest data(@javax.annotation.Nullable OpenEditorRequestData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public OpenEditorRequestData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable OpenEditorRequestData data) {
    this.data = data;
  }


  public OpenEditorRequest language(@javax.annotation.Nullable LanguageEnum language) {
  ...
  public boolean equals(Object o) {
    ...
    OpenEditorRequest openEditorRequest = (OpenEditorRequest) o;
    return Objects.equals(this.data, openEditorRequest.data) &&
        Objects.equals(this.language, openEditorRequest.language);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("data", "language"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to OpenEditorRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OpenEditorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OpenEditorRequest is not found in the empty JSON string", OpenEditorRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OpenEditorRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OpenEditorRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        OpenEditorRequestData.validateJsonElement(jsonObj.get("data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OpenEditorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OpenEditorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OpenEditorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OpenEditorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OpenEditorRequest>() {
           @Override
           public void write(JsonWriter out, OpenEditorRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OpenEditorRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OpenEditorRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OpenEditorRequest
   * @throws IOException if the JSON string is invalid with respect to OpenEditorRequest
   */
  public static OpenEditorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OpenEditorRequest.class);
  }

  /**
   * Convert an instance of OpenEditorRequest to an JSON string
   *
   * @return JSON string
   */
