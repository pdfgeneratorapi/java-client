...
public class InlineObject22Response {
  public static final String SERIALIZED_NAME_JOB_ID = "job_id";
  @SerializedName(SERIALIZED_NAME_JOB_ID)
  @javax.annotation.Nullable
  private String jobId;

  public InlineObject22Response() {
  }

  public InlineObject22Response jobId(@javax.annotation.Nullable String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InlineObject22Response inlineObject22Response = (InlineObject22Response) o;
    return Objects.equals(this.jobId, inlineObject22Response.jobId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject22Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject22Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineObject22Response is not found in the empty JSON string", InlineObject22Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject22Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject22Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineObject22Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineObject22Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineObject22Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineObject22Response.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineObject22Response>() {
           @Override
           public void write(JsonWriter out, InlineObject22Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineObject22Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineObject22Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineObject22Response
   * @throws IOException if the JSON string is invalid with respect to InlineObject22Response
   */
  public static InlineObject22Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineObject22Response.class);
  }

  /**
   * Convert an instance of InlineObject22Response to an JSON string
   *
   * @return JSON string
   */
