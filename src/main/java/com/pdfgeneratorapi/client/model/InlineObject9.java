...
import com.pdfgeneratorapi.client.model.InlineObject9Meta;
...
public class InlineObject9 {
  ...
  @javax.annotation.Nullable
  private InlineObject9Meta meta;

  public InlineObject9() {
  }

  public InlineObject9 response(@javax.annotation.Nullable String response) {
  ...
  public InlineObject9 meta(@javax.annotation.Nullable InlineObject9Meta meta) {
    this.meta = meta;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public InlineObject9Meta getMeta() {
    return meta;
  }

  public void setMeta(@javax.annotation.Nullable InlineObject9Meta meta) {
    this.meta = meta;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject9.response) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject9
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject9.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject9.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject9` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        InlineObject9Meta.validateJsonElement(jsonObj.get("meta"));
      }
  }
