...
public class ConvertURL2PDFRequest {
  ...
  public ConvertURL2PDFRequest url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public ConvertURL2PDFRequest paperSize(@javax.annotation.Nullable PaperSizeEnum paperSize) {
  ...
  public ConvertURL2PDFRequest orientation(@javax.annotation.Nullable OrientationEnum orientation) {
  ...
  public ConvertURL2PDFRequest output(@javax.annotation.Nullable OutputEnum output) {
    this.output = output;
    return this;
  }
  ...
  public ConvertURL2PDFRequest filename(@javax.annotation.Nullable String filename) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("url", "paper_size", "orientation", "output", "filename"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConvertURL2PDFRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConvertURL2PDFRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConvertURL2PDFRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConvertURL2PDFRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
