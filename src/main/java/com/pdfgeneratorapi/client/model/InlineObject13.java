...
public class InlineObject13 {
  ...
  public InlineObject13 jobId(@javax.annotation.Nullable String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public InlineObject13 status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.jobId, inlineObject13.jobId) &&
        Objects.equals(this.status, inlineObject13.status);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject13
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject13.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject13.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject13` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
