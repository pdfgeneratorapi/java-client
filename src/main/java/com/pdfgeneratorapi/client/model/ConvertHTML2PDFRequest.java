...
public class ConvertHTML2PDFRequest {
  ...
  public ConvertHTML2PDFRequest() {
  }

  public ConvertHTML2PDFRequest content(@javax.annotation.Nullable String content) {
  ...
  public ConvertHTML2PDFRequest paperSize(@javax.annotation.Nullable PaperSizeEnum paperSize) {
  ...
  public ConvertHTML2PDFRequest orientation(@javax.annotation.Nullable OrientationEnum orientation) {
  ...
  public ConvertHTML2PDFRequest output(@javax.annotation.Nullable OutputEnum output) {
    this.output = output;
    return this;
  }
  ...
  public ConvertHTML2PDFRequest filename(@javax.annotation.Nullable String filename) {
  ...
  public boolean equals(Object o) {
    ...
    ConvertHTML2PDFRequest convertHTML2PDFRequest = (ConvertHTML2PDFRequest) o;
    return Objects.equals(this.content, convertHTML2PDFRequest.content) &&
        Objects.equals(this.paperSize, convertHTML2PDFRequest.paperSize) &&
        Objects.equals(this.orientation, convertHTML2PDFRequest.orientation) &&
        Objects.equals(this.output, convertHTML2PDFRequest.output) &&
        Objects.equals(this.filename, convertHTML2PDFRequest.filename);
  }

  @Override
  public int hashCode() {
    return Objects.hash(content, paperSize, orientation, output, filename);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("content", "paper_size", "orientation", "output", "filename"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConvertHTML2PDFRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConvertHTML2PDFRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConvertHTML2PDFRequest is not found in the empty JSON string", ConvertHTML2PDFRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConvertHTML2PDFRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConvertHTML2PDFRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConvertHTML2PDFRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConvertHTML2PDFRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConvertHTML2PDFRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConvertHTML2PDFRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ConvertHTML2PDFRequest>() {
           @Override
           public void write(JsonWriter out, ConvertHTML2PDFRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConvertHTML2PDFRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConvertHTML2PDFRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConvertHTML2PDFRequest
   * @throws IOException if the JSON string is invalid with respect to ConvertHTML2PDFRequest
   */
  public static ConvertHTML2PDFRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConvertHTML2PDFRequest.class);
  }

  /**
   * Convert an instance of ConvertHTML2PDFRequest to an JSON string
   *
   * @return JSON string
   */
