...
public class DocumentUser {
  ...
  public DocumentUser firstName(@javax.annotation.Nullable String firstName) {
  ...
  public DocumentUser lastName(@javax.annotation.Nullable String lastName) {
  ...
  public DocumentUser email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public DocumentUser idCode(@javax.annotation.Nullable String idCode) {
    this.idCode = idCode;
    return this;
  }
  ...
  public DocumentUser ip(@javax.annotation.Nullable String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.firstName, documentUser.firstName) &&
        Objects.equals(this.lastName, documentUser.lastName) &&
        Objects.equals(this.email, documentUser.email) &&
        Objects.equals(this.idCode, documentUser.idCode) &&
        Objects.equals(this.ip, documentUser.ip);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(firstName, lastName, email, idCode, ip);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("first_name", "last_name", "email", "id_code", "ip"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentUser is not found in the empty JSON string", DocumentUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DocumentUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentUser.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentUser>() {
           @Override
           public void write(JsonWriter out, DocumentUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DocumentUser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DocumentUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentUser
   * @throws IOException if the JSON string is invalid with respect to DocumentUser
   */
  public static DocumentUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentUser.class);
  }

  /**
   * Convert an instance of DocumentUser to an JSON string
   *
   * @return JSON string
   */
