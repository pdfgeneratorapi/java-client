...
public class InlineObject31 {
  ...
  public InlineObject31 message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, inlineObject31.message);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject31
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject31.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject31.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject31` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
