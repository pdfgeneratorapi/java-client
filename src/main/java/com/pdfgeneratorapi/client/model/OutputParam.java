 ...
 */
@JsonAdapter(OutputParam.Adapter.class)
public enum OutputParam {
  ...
  public static OutputParam fromValue(String value) {
    for (OutputParam b : OutputParam.values()) {
  ...
  public static class Adapter extends TypeAdapter<OutputParam> {
    @Override
    public void write(final JsonWriter jsonWriter, final OutputParam enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OutputParam read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OutputParam.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OutputParam.fromValue(value);
  }
}
