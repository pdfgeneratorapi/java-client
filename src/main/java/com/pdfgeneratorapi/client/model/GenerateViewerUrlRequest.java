...
public class GenerateViewerUrlRequest {
  /**
  ...
  public GenerateViewerUrlRequest() {
  }

  public GenerateViewerUrlRequest output(@javax.annotation.Nullable OutputEnum output) {
    this.output = output;
    return this;
  }
  ...
  public GenerateViewerUrlRequest prefill(@javax.annotation.Nullable PrefillParam prefill) {
  ...
  public boolean equals(Object o) {
    ...
    GenerateViewerUrlRequest generateViewerUrlRequest = (GenerateViewerUrlRequest) o;
    return Objects.equals(this.output, generateViewerUrlRequest.output) &&
        Objects.equals(this.prefill, generateViewerUrlRequest.prefill);
  }

  @Override
  public int hashCode() {
    return Objects.hash(output, prefill);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GenerateViewerUrlRequest {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("output", "prefill"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateViewerUrlRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateViewerUrlRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateViewerUrlRequest is not found in the empty JSON string", GenerateViewerUrlRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateViewerUrlRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateViewerUrlRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateViewerUrlRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateViewerUrlRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateViewerUrlRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateViewerUrlRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateViewerUrlRequest>() {
           @Override
           public void write(JsonWriter out, GenerateViewerUrlRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateViewerUrlRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateViewerUrlRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateViewerUrlRequest
   * @throws IOException if the JSON string is invalid with respect to GenerateViewerUrlRequest
   */
  public static GenerateViewerUrlRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateViewerUrlRequest.class);
  }

  /**
   * Convert an instance of GenerateViewerUrlRequest to an JSON string
   *
   * @return JSON string
   */
