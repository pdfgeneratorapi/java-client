...
public class ConvertPDF2ImageRequest {
  ...
  @javax.annotation.Nullable
  private Integer resolution = 150;
  ...
  public ConvertPDF2ImageRequest() {
  }

  public ConvertPDF2ImageRequest fileBase64(@javax.annotation.Nullable String fileBase64) {
  ...
  public ConvertPDF2ImageRequest fileUrl(@javax.annotation.Nullable String fileUrl) {
  ...
  public ConvertPDF2ImageRequest format(@javax.annotation.Nullable FormatEnum format) {
    this.format = format;
    return this;
  }
  ...
  public ConvertPDF2ImageRequest quality(@javax.annotation.Nullable Integer quality) {
  ...
  public ConvertPDF2ImageRequest resolution(@javax.annotation.Nullable Integer resolution) {
  ...
  public void setResolution(@javax.annotation.Nullable Integer resolution) {
    this.resolution = resolution;
  }


  public ConvertPDF2ImageRequest pages(@javax.annotation.Nullable String pages) {
    this.pages = pages;
    return this;
  }
  ...
  public ConvertPDF2ImageRequest output(@javax.annotation.Nullable OutputEnum output) {
    this.output = output;
    return this;
  }
  ...
  public ConvertPDF2ImageRequest name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConvertPDF2ImageRequest convertPDF2ImageRequest = (ConvertPDF2ImageRequest) o;
    return Objects.equals(this.fileBase64, convertPDF2ImageRequest.fileBase64) &&
        Objects.equals(this.fileUrl, convertPDF2ImageRequest.fileUrl) &&
        Objects.equals(this.format, convertPDF2ImageRequest.format) &&
        Objects.equals(this.quality, convertPDF2ImageRequest.quality) &&
        Objects.equals(this.resolution, convertPDF2ImageRequest.resolution) &&
        Objects.equals(this.pages, convertPDF2ImageRequest.pages) &&
        Objects.equals(this.output, convertPDF2ImageRequest.output) &&
        Objects.equals(this.name, convertPDF2ImageRequest.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileBase64, fileUrl, format, quality, resolution, pages, output, name);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("file_base64", "file_url", "format", "quality", "resolution", "pages", "output", "name"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConvertPDF2ImageRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConvertPDF2ImageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConvertPDF2ImageRequest is not found in the empty JSON string", ConvertPDF2ImageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConvertPDF2ImageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConvertPDF2ImageRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConvertPDF2ImageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConvertPDF2ImageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConvertPDF2ImageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConvertPDF2ImageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ConvertPDF2ImageRequest>() {
           @Override
           public void write(JsonWriter out, ConvertPDF2ImageRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConvertPDF2ImageRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConvertPDF2ImageRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConvertPDF2ImageRequest
   * @throws IOException if the JSON string is invalid with respect to ConvertPDF2ImageRequest
   */
  public static ConvertPDF2ImageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConvertPDF2ImageRequest.class);
  }

  /**
   * Convert an instance of ConvertPDF2ImageRequest to an JSON string
   *
   * @return JSON string
   */
