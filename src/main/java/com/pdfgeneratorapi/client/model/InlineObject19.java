...
public class InlineObject19 {
  ...
  public InlineObject19 response(@javax.annotation.Nullable FormConfiguration response) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject19.response);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject19
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject19.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject19.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject19` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
