...
/**
 * Gets or Sets AccessibilityOption
 */
@JsonAdapter(AccessibilityOption.Adapter.class)
public enum AccessibilityOption {
  ...
  AccessibilityOption(String value) {
    this.value = value;
  }
  ...
  public static AccessibilityOption fromValue(String value) {
    for (AccessibilityOption b : AccessibilityOption.values()) {
  ...
  public static class Adapter extends TypeAdapter<AccessibilityOption> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccessibilityOption enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccessibilityOption read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccessibilityOption.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AccessibilityOption.fromValue(value);
  }
}
