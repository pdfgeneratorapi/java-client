...
import com.pdfgeneratorapi.client.model.Workspace;
...
public class InlineObject5 {
  ...
  private List<Workspace> response = new ArrayList<>();
  ...
  public InlineObject5 response(@javax.annotation.Nullable List<Workspace> response) {
    this.response = response;
    return this;
  }

  public InlineObject5 addResponseItem(Workspace responseItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<Workspace> getResponse() {
    return response;
  }

  public void setResponse(@javax.annotation.Nullable List<Workspace> response) {
    this.response = response;
  }


  public InlineObject5 meta(@javax.annotation.Nullable PaginationMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject5.response) &&
      ...
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        ...
        if (jsonArrayresponse != null) {
          ...
          for (int i = 0; i < jsonArrayresponse.size(); i++) {
            Workspace.validateJsonElement(jsonArrayresponse.get(i));
          };
        }
      }
