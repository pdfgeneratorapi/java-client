...
public class PrefillParam {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(idCode, firstName, lastName, email, editable);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id_code", "first_name", "last_name", "email", "editable"));
