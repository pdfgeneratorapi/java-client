...
public class PrefillParam {
  ...
  public PrefillParam idCode(@javax.annotation.Nullable String idCode) {
    this.idCode = idCode;
    return this;
  }
  ...
  public void setIdCode(@javax.annotation.Nullable String idCode) {
    this.idCode = idCode;
  }


  public PrefillParam firstName(@javax.annotation.Nullable String firstName) {
  ...
  public PrefillParam lastName(@javax.annotation.Nullable String lastName) {
  ...
  public PrefillParam email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public PrefillParam signatureId(@javax.annotation.Nullable String signatureId) {
  ...
  public PrefillParam editable(@javax.annotation.Nullable Boolean editable) {
  ...
  public boolean equals(Object o) {
    ...
    PrefillParam prefillParam = (PrefillParam) o;
    return Objects.equals(this.idCode, prefillParam.idCode) &&
        Objects.equals(this.firstName, prefillParam.firstName) &&
        Objects.equals(this.lastName, prefillParam.lastName) &&
        Objects.equals(this.email, prefillParam.email) &&
        Objects.equals(this.signatureId, prefillParam.signatureId) &&
        Objects.equals(this.editable, prefillParam.editable);
  }

  @Override
  public int hashCode() {
    return Objects.hash(idCode, firstName, lastName, email, signatureId, editable);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PrefillParam {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id_code", "first_name", "last_name", "email", "signature_id", "editable"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to PrefillParam
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PrefillParam.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrefillParam is not found in the empty JSON string", PrefillParam.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PrefillParam.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PrefillParam` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrefillParam.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrefillParam' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrefillParam> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrefillParam.class));

       return (TypeAdapter<T>) new TypeAdapter<PrefillParam>() {
           @Override
           public void write(JsonWriter out, PrefillParam value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PrefillParam read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PrefillParam given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PrefillParam
   * @throws IOException if the JSON string is invalid with respect to PrefillParam
   */
  public static PrefillParam fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrefillParam.class);
  }

  /**
   * Convert an instance of PrefillParam to an JSON string
   *
   * @return JSON string
   */
