...
public class TemplateDefinitionNewDataSettings {
  ...
  @javax.annotation.Nullable
  private List<Object> transform = new ArrayList<>();

  public TemplateDefinitionNewDataSettings() {
  }

  public TemplateDefinitionNewDataSettings sortBy(@javax.annotation.Nullable List<Object> sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  public void setSortBy(@javax.annotation.Nullable List<Object> sortBy) {
    this.sortBy = sortBy;
  }


  public TemplateDefinitionNewDataSettings filterBy(@javax.annotation.Nullable List<Object> filterBy) {
  ...
  public void setFilterBy(@javax.annotation.Nullable List<Object> filterBy) {
    this.filterBy = filterBy;
  }


  public TemplateDefinitionNewDataSettings transform(@javax.annotation.Nullable List<Object> transform) {
    this.transform = transform;
    return this;
  }

  public TemplateDefinitionNewDataSettings addTransformItem(Object transformItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<Object> getTransform() {
    return transform;
  }

  public void setTransform(@javax.annotation.Nullable List<Object> transform) {
    this.transform = transform;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sortBy, templateDefinitionNewDataSettings.sortBy) &&
        ...
        Objects.equals(this.transform, templateDefinitionNewDataSettings.transform);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sortBy, filterBy, transform);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sortBy", "filterBy", "transform"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateDefinitionNewDataSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateDefinitionNewDataSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateDefinitionNewDataSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateDefinitionNewDataSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("transform") != null && !jsonObj.get("transform").isJsonNull() && !jsonObj.get("transform").isJsonArray()) {
