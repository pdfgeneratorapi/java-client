...
public class InlineObject28 {
  ...
  public InlineObject28 message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, inlineObject28.message);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject28
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject28.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject28.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject28` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
