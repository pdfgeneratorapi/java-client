...
public class GenerateQRCodeRequest {
  ...
  public static final String SERIALIZED_NAME_LOGO_BASE64 = "logo_base64";
  ...
  public GenerateQRCodeRequest content(@javax.annotation.Nonnull String content) {
  ...
  public GenerateQRCodeRequest color(@javax.annotation.Nullable String color) {
    this.color = color;
    return this;
  }
  ...
  public GenerateQRCodeRequest logoBase64(@javax.annotation.Nullable String logoBase64) {
  ...
  public void setLogoBase64(@javax.annotation.Nullable String logoBase64) {
    this.logoBase64 = logoBase64;
  }


  public GenerateQRCodeRequest logoUrl(@javax.annotation.Nullable String logoUrl) {
  ...
  public GenerateQRCodeRequest output(@javax.annotation.Nullable OutputEnum output) {
    this.output = output;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GenerateQRCodeRequest generateQRCodeRequest = (GenerateQRCodeRequest) o;
    return Objects.equals(this.content, generateQRCodeRequest.content) &&
        Objects.equals(this.color, generateQRCodeRequest.color) &&
        Objects.equals(this.logoBase64, generateQRCodeRequest.logoBase64) &&
        Objects.equals(this.logoUrl, generateQRCodeRequest.logoUrl) &&
        Objects.equals(this.output, generateQRCodeRequest.output);
  }

  @Override
  public int hashCode() {
    return Objects.hash(content, color, logoBase64, logoUrl, output);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("content", "color", "logo_base64", "logo_url", "output"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateQRCodeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateQRCodeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateQRCodeRequest is not found in the empty JSON string", GenerateQRCodeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateQRCodeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateQRCodeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenerateQRCodeRequest.openapiRequiredFields) {
      ...
      if ((jsonObj.get("logo_base64") != null && !jsonObj.get("logo_base64").isJsonNull()) && !jsonObj.get("logo_base64").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `logo_base64` to be a primitive type in the JSON string but got `%s`", jsonObj.get("logo_base64").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateQRCodeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateQRCodeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateQRCodeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateQRCodeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateQRCodeRequest>() {
           @Override
           public void write(JsonWriter out, GenerateQRCodeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateQRCodeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateQRCodeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateQRCodeRequest
   * @throws IOException if the JSON string is invalid with respect to GenerateQRCodeRequest
   */
  public static GenerateQRCodeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateQRCodeRequest.class);
  }

  /**
   * Convert an instance of GenerateQRCodeRequest to an JSON string
   *
   * @return JSON string
   */
