...
public class PaginationMeta {
  ...
  public PaginationMeta currentPage(@javax.annotation.Nullable BigDecimal currentPage) {
  ...
  public void setCurrentPage(@javax.annotation.Nullable BigDecimal currentPage) {
    this.currentPage = currentPage;
  }


  public PaginationMeta lastPage(@javax.annotation.Nullable BigDecimal lastPage) {
  ...
  public void setLastPage(@javax.annotation.Nullable BigDecimal lastPage) {
    this.lastPage = lastPage;
  }


  public PaginationMeta perPage(@javax.annotation.Nullable BigDecimal perPage) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currentPage, paginationMeta.currentPage) &&
        Objects.equals(this.lastPage, paginationMeta.lastPage) &&
        Objects.equals(this.perPage, paginationMeta.perPage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currentPage, lastPage, perPage);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("current_page", "last_page", "per_page"));
