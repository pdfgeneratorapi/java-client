...
public class TemplateDefinitionNewEditor {
  ...
  public TemplateDefinitionNewEditor heightMultiplier(@javax.annotation.Nullable BigDecimal heightMultiplier) {
  ...
  public void setHeightMultiplier(@javax.annotation.Nullable BigDecimal heightMultiplier) {
    this.heightMultiplier = heightMultiplier;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("heightMultiplier"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateDefinitionNewEditor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateDefinitionNewEditor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateDefinitionNewEditor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateDefinitionNewEditor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
