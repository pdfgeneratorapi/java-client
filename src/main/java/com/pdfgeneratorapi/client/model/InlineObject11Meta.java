...
public class InlineObject11Meta {
  ...
  public InlineObject11Meta() {
  }

  public InlineObject11Meta name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public InlineObject11Meta displayName(@javax.annotation.Nullable String displayName) {
  ...
  public InlineObject11Meta encoding(@javax.annotation.Nullable String encoding) {
  ...
  public InlineObject11Meta contentType(@javax.annotation.Nullable String contentType) {
  ...
  public InlineObject11Meta publicId(@javax.annotation.Nullable String publicId) {
  ...
  public boolean equals(Object o) {
    ...
    InlineObject11Meta inlineObject11Meta = (InlineObject11Meta) o;
    return Objects.equals(this.name, inlineObject11Meta.name) &&
        Objects.equals(this.displayName, inlineObject11Meta.displayName) &&
        Objects.equals(this.encoding, inlineObject11Meta.encoding) &&
        Objects.equals(this.contentType, inlineObject11Meta.contentType) &&
        Objects.equals(this.publicId, inlineObject11Meta.publicId);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "display_name", "encoding", "content-type", "public_id"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject11Meta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject11Meta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineObject11Meta is not found in the empty JSON string", InlineObject11Meta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject11Meta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject11Meta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineObject11Meta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineObject11Meta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineObject11Meta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineObject11Meta.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineObject11Meta>() {
           @Override
           public void write(JsonWriter out, InlineObject11Meta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineObject11Meta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineObject11Meta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineObject11Meta
   * @throws IOException if the JSON string is invalid with respect to InlineObject11Meta
   */
  public static InlineObject11Meta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineObject11Meta.class);
  }

  /**
   * Convert an instance of InlineObject11Meta to an JSON string
   *
   * @return JSON string
   */
