...
import com.pdfgeneratorapi.client.model.TemplateDefinitionNewLayoutMargins;
import com.pdfgeneratorapi.client.model.TemplateDefinitionNewLayoutRepeatLayout;
...
public class TemplateDefinitionNewLayout {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("format", "width", "height", "unit", "orientation", "rotation", "margins", "repeatLayout", "emptyLabels"));
