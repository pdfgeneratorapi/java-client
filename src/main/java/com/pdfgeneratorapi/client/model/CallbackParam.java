...
public class CallbackParam {
  ...
  public CallbackParam url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public CallbackParam headers(@javax.annotation.Nullable Object headers) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CallbackParam
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CallbackParam.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CallbackParam.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CallbackParam` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
