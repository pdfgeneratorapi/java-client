...
import com.pdfgeneratorapi.client.model.InlineObject10Meta;
...
public class InlineObject10 {
  ...
  @javax.annotation.Nullable
  private InlineObject10Meta meta;

  public InlineObject10() {
  }

  public InlineObject10 response(@javax.annotation.Nullable List<String> response) {
    this.response = response;
    return this;
  }

  public InlineObject10 addResponseItem(String responseItem) {
  ...
  public InlineObject10 meta(@javax.annotation.Nullable InlineObject10Meta meta) {
    this.meta = meta;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public InlineObject10Meta getMeta() {
    return meta;
  }

  public void setMeta(@javax.annotation.Nullable InlineObject10Meta meta) {
    this.meta = meta;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject10.response) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject10
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject10.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject10.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject10` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull() && !jsonObj.get("response").isJsonArray()) {
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        InlineObject10Meta.validateJsonElement(jsonObj.get("meta"));
      }
  }
