...
public class InlineObject10Meta {
  ...
  public InlineObject10Meta() {
  }

  public InlineObject10Meta name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public InlineObject10Meta displayName(@javax.annotation.Nullable String displayName) {
  ...
  public InlineObject10Meta encoding(@javax.annotation.Nullable String encoding) {
  ...
  public InlineObject10Meta contentType(@javax.annotation.Nullable String contentType) {
  ...
  public boolean equals(Object o) {
    ...
    InlineObject10Meta inlineObject10Meta = (InlineObject10Meta) o;
    return Objects.equals(this.name, inlineObject10Meta.name) &&
        Objects.equals(this.displayName, inlineObject10Meta.displayName) &&
        Objects.equals(this.encoding, inlineObject10Meta.encoding) &&
        Objects.equals(this.contentType, inlineObject10Meta.contentType);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "display_name", "encoding", "content-type"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject10Meta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject10Meta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineObject10Meta is not found in the empty JSON string", InlineObject10Meta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject10Meta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject10Meta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineObject10Meta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineObject10Meta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineObject10Meta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineObject10Meta.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineObject10Meta>() {
           @Override
           public void write(JsonWriter out, InlineObject10Meta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineObject10Meta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineObject10Meta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineObject10Meta
   * @throws IOException if the JSON string is invalid with respect to InlineObject10Meta
   */
  public static InlineObject10Meta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineObject10Meta.class);
  }

  /**
   * Convert an instance of InlineObject10Meta to an JSON string
   *
   * @return JSON string
   */
