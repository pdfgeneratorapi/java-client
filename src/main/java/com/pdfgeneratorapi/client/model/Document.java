...
public class Document {
  ...
  public Document publicId(@javax.annotation.Nullable String publicId) {
  ...
  public Document publicUrl(@javax.annotation.Nullable String publicUrl) {
  ...
  public Document templateId(@javax.annotation.Nullable Integer templateId) {
  ...
  public Document createdAt(@javax.annotation.Nullable String createdAt) {
  ...
  public Document expiresAt(@javax.annotation.Nullable String expiresAt) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("public_id", "public_url", "template_id", "created_at", "expires_at"));
