...
public class InlineObject20Response {
  public static final String SERIALIZED_NAME_JOB_ID = "job_id";
  @SerializedName(SERIALIZED_NAME_JOB_ID)
  @javax.annotation.Nullable
  private String jobId;

  public InlineObject20Response() {
  }

  public InlineObject20Response jobId(@javax.annotation.Nullable String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InlineObject20Response inlineObject20Response = (InlineObject20Response) o;
    return Objects.equals(this.jobId, inlineObject20Response.jobId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject20Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject20Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineObject20Response is not found in the empty JSON string", InlineObject20Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject20Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject20Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineObject20Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineObject20Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineObject20Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineObject20Response.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineObject20Response>() {
           @Override
           public void write(JsonWriter out, InlineObject20Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineObject20Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineObject20Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineObject20Response
   * @throws IOException if the JSON string is invalid with respect to InlineObject20Response
   */
  public static InlineObject20Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineObject20Response.class);
  }

  /**
   * Convert an instance of InlineObject20Response to an JSON string
   *
   * @return JSON string
   */
