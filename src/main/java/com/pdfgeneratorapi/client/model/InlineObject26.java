...
public class InlineObject26 {
  ...
  public InlineObject26 message(@javax.annotation.Nullable MessageEnum message) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, inlineObject26.message);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject26
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject26.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject26.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject26` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
