...
public class EncryptAndDecryptBase64 {
  ...
  public EncryptAndDecryptBase64() {
  }

  public EncryptAndDecryptBase64 fileBase64(@javax.annotation.Nonnull String fileBase64) {
  ...
  public EncryptAndDecryptBase64 ownerPassword(@javax.annotation.Nonnull String ownerPassword) {
  ...
  public void setOwnerPassword(@javax.annotation.Nonnull String ownerPassword) {
    this.ownerPassword = ownerPassword;
  }


  public EncryptAndDecryptBase64 userPassword(@javax.annotation.Nullable String userPassword) {
  ...
  public EncryptAndDecryptBase64 name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public EncryptAndDecryptBase64 output(@javax.annotation.Nullable OutputEnum output) {
    this.output = output;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EncryptAndDecryptBase64 encryptAndDecryptBase64 = (EncryptAndDecryptBase64) o;
    return Objects.equals(this.fileBase64, encryptAndDecryptBase64.fileBase64) &&
        Objects.equals(this.ownerPassword, encryptAndDecryptBase64.ownerPassword) &&
        Objects.equals(this.userPassword, encryptAndDecryptBase64.userPassword) &&
        Objects.equals(this.name, encryptAndDecryptBase64.name) &&
        Objects.equals(this.output, encryptAndDecryptBase64.output);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileBase64, ownerPassword, userPassword, name, output);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("file_base64", "owner_password", "user_password", "name", "output"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("file_base64", "owner_password"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EncryptAndDecryptBase64
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EncryptAndDecryptBase64.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EncryptAndDecryptBase64 is not found in the empty JSON string", EncryptAndDecryptBase64.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EncryptAndDecryptBase64.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EncryptAndDecryptBase64` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EncryptAndDecryptBase64.openapiRequiredFields) {
      ...
      if (!jsonObj.get("owner_password").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `owner_password` to be a primitive type in the JSON string but got `%s`", jsonObj.get("owner_password").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EncryptAndDecryptBase64.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EncryptAndDecryptBase64' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EncryptAndDecryptBase64> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EncryptAndDecryptBase64.class));

       return (TypeAdapter<T>) new TypeAdapter<EncryptAndDecryptBase64>() {
           @Override
           public void write(JsonWriter out, EncryptAndDecryptBase64 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EncryptAndDecryptBase64 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EncryptAndDecryptBase64 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EncryptAndDecryptBase64
   * @throws IOException if the JSON string is invalid with respect to EncryptAndDecryptBase64
   */
  public static EncryptAndDecryptBase64 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EncryptAndDecryptBase64.class);
  }

  /**
   * Convert an instance of EncryptAndDecryptBase64 to an JSON string
   *
   * @return JSON string
   */
