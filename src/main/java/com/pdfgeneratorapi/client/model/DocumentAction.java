...
public class DocumentAction {
  ...
  public DocumentAction action(@javax.annotation.Nullable ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  public DocumentAction person(@javax.annotation.Nullable DocumentUser person) {
    this.person = person;
    return this;
  }
  ...
  public DocumentAction createdAt(@javax.annotation.Nullable String createdAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.action, documentAction.action) &&
        Objects.equals(this.person, documentAction.person) &&
        Objects.equals(this.createdAt, documentAction.createdAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, person, createdAt);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("action", "person", "created_at"));
