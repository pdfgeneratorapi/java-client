...
public class InlineObject20Meta {
  public static final String SERIALIZED_NAME_PUBLIC_ID = "public_id";
  @SerializedName(SERIALIZED_NAME_PUBLIC_ID)
  @javax.annotation.Nullable
  private String publicId;

  public InlineObject20Meta() {
  }

  public InlineObject20Meta publicId(@javax.annotation.Nullable String publicId) {
  ...
  public boolean equals(Object o) {
    ...
    InlineObject20Meta inlineObject20Meta = (InlineObject20Meta) o;
    return Objects.equals(this.publicId, inlineObject20Meta.publicId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject20Meta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject20Meta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineObject20Meta is not found in the empty JSON string", InlineObject20Meta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject20Meta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject20Meta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineObject20Meta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineObject20Meta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineObject20Meta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineObject20Meta.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineObject20Meta>() {
           @Override
           public void write(JsonWriter out, InlineObject20Meta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineObject20Meta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineObject20Meta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineObject20Meta
   * @throws IOException if the JSON string is invalid with respect to InlineObject20Meta
   */
  public static InlineObject20Meta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineObject20Meta.class);
  }

  /**
   * Convert an instance of InlineObject20Meta to an JSON string
   *
   * @return JSON string
   */
