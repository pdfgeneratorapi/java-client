...
public class GenerateQRCode201ResponseMeta {
  ...
  public GenerateQRCode201ResponseMeta() {
  }

  public GenerateQRCode201ResponseMeta encoding(@javax.annotation.Nullable String encoding) {
  ...
  public GenerateQRCode201ResponseMeta contentType(@javax.annotation.Nullable String contentType) {
  ...
  public boolean equals(Object o) {
    ...
    GenerateQRCode201ResponseMeta generateQRCode201ResponseMeta = (GenerateQRCode201ResponseMeta) o;
    return Objects.equals(this.encoding, generateQRCode201ResponseMeta.encoding) &&
        Objects.equals(this.contentType, generateQRCode201ResponseMeta.contentType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(encoding, contentType);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("encoding", "content-type"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateQRCode201ResponseMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateQRCode201ResponseMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateQRCode201ResponseMeta is not found in the empty JSON string", GenerateQRCode201ResponseMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateQRCode201ResponseMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateQRCode201ResponseMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateQRCode201ResponseMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateQRCode201ResponseMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateQRCode201ResponseMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateQRCode201ResponseMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateQRCode201ResponseMeta>() {
           @Override
           public void write(JsonWriter out, GenerateQRCode201ResponseMeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateQRCode201ResponseMeta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateQRCode201ResponseMeta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateQRCode201ResponseMeta
   * @throws IOException if the JSON string is invalid with respect to GenerateQRCode201ResponseMeta
   */
  public static GenerateQRCode201ResponseMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateQRCode201ResponseMeta.class);
  }

  /**
   * Convert an instance of GenerateQRCode201ResponseMeta to an JSON string
   *
   * @return JSON string
   */
