...
import com.pdfgeneratorapi.client.model.InlineObject14ResponseValue;
...
public class InlineObject14 {
  ...
  private Map<String, InlineObject14ResponseValue> response = new HashMap<>();

  public InlineObject14() {
  }

  public InlineObject14 response(@javax.annotation.Nullable Map<String, InlineObject14ResponseValue> response) {
    this.response = response;
    return this;
  }

  public InlineObject14 putResponseItem(String key, InlineObject14ResponseValue responseItem) {
   ...
   */
  @javax.annotation.Nullable
  public Map<String, InlineObject14ResponseValue> getResponse() {
    return response;
  }

  public void setResponse(@javax.annotation.Nullable Map<String, InlineObject14ResponseValue> response) {
    this.response = response;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject14.response);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject14
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject14.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject14.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject14` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
