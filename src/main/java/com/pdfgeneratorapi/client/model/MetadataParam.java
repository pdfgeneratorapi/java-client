...
public class MetadataParam {
  ...
  private String author = "Organization name";
  ...
  public MetadataParam author(@javax.annotation.Nullable String author) {
    this.author = author;
    return this;
  }
  ...
  public MetadataParam language(@javax.annotation.Nullable String language) {
  ...
  public boolean equals(Object o) {
    ...
    MetadataParam metadataParam = (MetadataParam) o;
    return Objects.equals(this.author, metadataParam.author) &&
        Objects.equals(this.language, metadataParam.language);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("author", "language"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to MetadataParam
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetadataParam.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MetadataParam is not found in the empty JSON string", MetadataParam.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetadataParam.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetadataParam` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetadataParam.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetadataParam' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetadataParam> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetadataParam.class));

       return (TypeAdapter<T>) new TypeAdapter<MetadataParam>() {
           @Override
           public void write(JsonWriter out, MetadataParam value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MetadataParam read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MetadataParam given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MetadataParam
   * @throws IOException if the JSON string is invalid with respect to MetadataParam
   */
  public static MetadataParam fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetadataParam.class);
  }

  /**
   * Convert an instance of MetadataParam to an JSON string
   *
   * @return JSON string
   */
