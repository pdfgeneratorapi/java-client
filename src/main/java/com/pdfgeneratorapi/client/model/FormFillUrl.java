...
public class FormFillUrl {
  ...
  public FormFillUrl fileUrl(@javax.annotation.Nonnull String fileUrl) {
  ...
  public FormFillUrl data(@javax.annotation.Nonnull Object data) {
    this.data = data;
    return this;
  }
  ...
  public FormFillUrl output(@javax.annotation.Nullable OutputEnum output) {
    this.output = output;
    return this;
  }
  ...
  public FormFillUrl name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FormFillUrl formFillUrl = (FormFillUrl) o;
    return Objects.equals(this.fileUrl, formFillUrl.fileUrl) &&
        Objects.equals(this.data, formFillUrl.data) &&
        Objects.equals(this.output, formFillUrl.output) &&
        Objects.equals(this.name, formFillUrl.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileUrl, data, output, name);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("file_url", "data", "output", "name"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("file_url", "data"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FormFillUrl
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FormFillUrl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormFillUrl is not found in the empty JSON string", FormFillUrl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FormFillUrl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FormFillUrl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FormFillUrl.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormFillUrl.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormFillUrl' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormFillUrl> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormFillUrl.class));

       return (TypeAdapter<T>) new TypeAdapter<FormFillUrl>() {
           @Override
           public void write(JsonWriter out, FormFillUrl value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FormFillUrl read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FormFillUrl given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FormFillUrl
   * @throws IOException if the JSON string is invalid with respect to FormFillUrl
   */
  public static FormFillUrl fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormFillUrl.class);
  }

  /**
   * Convert an instance of FormFillUrl to an JSON string
   *
   * @return JSON string
   */
