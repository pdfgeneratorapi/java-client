...
public class OptimizeBase64 {
  ...
  public OptimizeBase64() {
  }

  public OptimizeBase64 fileBase64(@javax.annotation.Nonnull String fileBase64) {
  ...
  public OptimizeBase64 name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OptimizeBase64 output(@javax.annotation.Nullable OutputEnum output) {
    this.output = output;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OptimizeBase64 optimizeBase64 = (OptimizeBase64) o;
    return Objects.equals(this.fileBase64, optimizeBase64.fileBase64) &&
        Objects.equals(this.name, optimizeBase64.name) &&
        Objects.equals(this.output, optimizeBase64.output);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileBase64, name, output);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("file_base64", "name", "output"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to OptimizeBase64
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OptimizeBase64.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OptimizeBase64 is not found in the empty JSON string", OptimizeBase64.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OptimizeBase64.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OptimizeBase64` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OptimizeBase64.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OptimizeBase64.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OptimizeBase64' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OptimizeBase64> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OptimizeBase64.class));

       return (TypeAdapter<T>) new TypeAdapter<OptimizeBase64>() {
           @Override
           public void write(JsonWriter out, OptimizeBase64 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OptimizeBase64 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OptimizeBase64 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OptimizeBase64
   * @throws IOException if the JSON string is invalid with respect to OptimizeBase64
   */
  public static OptimizeBase64 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OptimizeBase64.class);
  }

  /**
   * Convert an instance of OptimizeBase64 to an JSON string
   *
   * @return JSON string
   */
