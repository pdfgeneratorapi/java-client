...
public class InlineObject23Response {
  public static final String SERIALIZED_NAME_JOB_ID = "job_id";
  @SerializedName(SERIALIZED_NAME_JOB_ID)
  @javax.annotation.Nullable
  private String jobId;

  public InlineObject23Response() {
  }

  public InlineObject23Response jobId(@javax.annotation.Nullable String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InlineObject23Response inlineObject23Response = (InlineObject23Response) o;
    return Objects.equals(this.jobId, inlineObject23Response.jobId);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineObject23Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject23Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject23Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineObject23Response is not found in the empty JSON string", InlineObject23Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject23Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject23Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineObject23Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineObject23Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineObject23Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineObject23Response.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineObject23Response>() {
           @Override
           public void write(JsonWriter out, InlineObject23Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineObject23Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineObject23Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineObject23Response
   * @throws IOException if the JSON string is invalid with respect to InlineObject23Response
   */
  public static InlineObject23Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineObject23Response.class);
  }

  /**
   * Convert an instance of InlineObject23Response to an JSON string
   *
   * @return JSON string
   */
