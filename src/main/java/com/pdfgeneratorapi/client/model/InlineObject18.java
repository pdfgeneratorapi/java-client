...
import com.pdfgeneratorapi.client.model.InlineObject18Meta;
...
public class InlineObject18 {
  ...
  @javax.annotation.Nullable
  private InlineObject18Meta meta;

  public InlineObject18() {
  }

  public InlineObject18 response(@javax.annotation.Nullable String response) {
  ...
  public InlineObject18 meta(@javax.annotation.Nullable InlineObject18Meta meta) {
    this.meta = meta;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public InlineObject18Meta getMeta() {
    return meta;
  }

  public void setMeta(@javax.annotation.Nullable InlineObject18Meta meta) {
    this.meta = meta;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject18.response) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject18
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject18.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject18.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject18` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        InlineObject18Meta.validateJsonElement(jsonObj.get("meta"));
      }
  }
