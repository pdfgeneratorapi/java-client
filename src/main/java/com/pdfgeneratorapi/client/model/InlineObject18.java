...
public class InlineObject18 {
  ...
  public InlineObject18 response(@javax.annotation.Nullable List<DocumentAction> response) {
    this.response = response;
    return this;
  }

  public InlineObject18 addResponseItem(DocumentAction responseItem) {
