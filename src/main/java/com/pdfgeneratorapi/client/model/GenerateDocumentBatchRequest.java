...
public class GenerateDocumentBatchRequest {
  ...
  public GenerateDocumentBatchRequest template(@javax.annotation.Nullable List<TemplateParam> template) {
  ...
  public GenerateDocumentBatchRequest format(@javax.annotation.Nullable FormatParam format) {
    this.format = format;
    return this;
  }
  ...
  public GenerateDocumentBatchRequest output(@javax.annotation.Nullable OutputParam output) {
    this.output = output;
    return this;
  }
  ...
  public GenerateDocumentBatchRequest name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GenerateDocumentBatchRequest testing(@javax.annotation.Nullable Boolean testing) {
  ...
  public GenerateDocumentBatchRequest metadata(@javax.annotation.Nullable MetadataParam metadata) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.template, generateDocumentBatchRequest.template) &&
        ...
        Objects.equals(this.testing, generateDocumentBatchRequest.testing) &&
        Objects.equals(this.metadata, generateDocumentBatchRequest.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(template, format, output, name, testing, metadata);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("template", "format", "output", "name", "testing", "metadata"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateDocumentBatchRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateDocumentBatchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateDocumentBatchRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateDocumentBatchRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
