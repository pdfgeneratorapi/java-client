...
import com.pdfgeneratorapi.client.model.Document;
...
public class InlineObject15 {
  ...
  public InlineObject15 response(@javax.annotation.Nullable List<Document> response) {
    this.response = response;
    return this;
  }

  public InlineObject15 addResponseItem(Document responseItem) {
  ...
  public InlineObject15 meta(@javax.annotation.Nullable PaginationMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject15.response) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject15
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject15.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject15.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject15` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
