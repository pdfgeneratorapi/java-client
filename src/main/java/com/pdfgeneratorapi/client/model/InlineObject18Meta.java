...
public class InlineObject18Meta {
  public static final String SERIALIZED_NAME_PUBLIC_ID = "public_id";
  @SerializedName(SERIALIZED_NAME_PUBLIC_ID)
  @javax.annotation.Nullable
  private String publicId;

  public InlineObject18Meta() {
  }

  public InlineObject18Meta publicId(@javax.annotation.Nullable String publicId) {
  ...
  public boolean equals(Object o) {
    ...
    InlineObject18Meta inlineObject18Meta = (InlineObject18Meta) o;
    return Objects.equals(this.publicId, inlineObject18Meta.publicId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject18Meta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject18Meta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineObject18Meta is not found in the empty JSON string", InlineObject18Meta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject18Meta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject18Meta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineObject18Meta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineObject18Meta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineObject18Meta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineObject18Meta.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineObject18Meta>() {
           @Override
           public void write(JsonWriter out, InlineObject18Meta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineObject18Meta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineObject18Meta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineObject18Meta
   * @throws IOException if the JSON string is invalid with respect to InlineObject18Meta
   */
  public static InlineObject18Meta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineObject18Meta.class);
  }

  /**
   * Convert an instance of InlineObject18Meta to an JSON string
   *
   * @return JSON string
   */
