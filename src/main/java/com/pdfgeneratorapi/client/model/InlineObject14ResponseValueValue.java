...
public class InlineObject14ResponseValueValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(InlineObject14ResponseValueValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!InlineObject14ResponseValueValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'InlineObject14ResponseValueValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<InlineObject14ResponseValueValue>() {
                @Override
                public void write(JsonWriter out, InlineObject14ResponseValueValue value) throws IOException {
                ...
                @Override
                public InlineObject14ResponseValueValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        InlineObject14ResponseValueValue ret = new InlineObject14ResponseValueValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for InlineObject14ResponseValueValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public InlineObject14ResponseValueValue() {
        super("oneOf", Boolean.FALSE);
    }

    public InlineObject14ResponseValueValue(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return InlineObject14ResponseValueValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to InlineObject14ResponseValueValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for InlineObject14ResponseValueValue with oneOf schemas: Boolean, List<String>, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of InlineObject14ResponseValueValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of InlineObject14ResponseValueValue
     * @throws IOException if the JSON string is invalid with respect to InlineObject14ResponseValueValue
     */
    public static InlineObject14ResponseValueValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, InlineObject14ResponseValueValue.class);
    }

    /**
     * Convert an instance of InlineObject14ResponseValueValue to an JSON string
     *
     * @return JSON string
     */
