...
import com.pdfgeneratorapi.client.model.InlineObject12MetaStats;
...
public class InlineObject12Meta {
  ...
  @javax.annotation.Nullable
  private InlineObject12MetaStats stats;
  ...
  public InlineObject12Meta() {
  }

  public InlineObject12Meta name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public InlineObject12Meta displayName(@javax.annotation.Nullable String displayName) {
  ...
  public InlineObject12Meta encoding(@javax.annotation.Nullable String encoding) {
  ...
  public InlineObject12Meta contentType(@javax.annotation.Nullable String contentType) {
  ...
  public InlineObject12Meta stats(@javax.annotation.Nullable InlineObject12MetaStats stats) {
    this.stats = stats;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public InlineObject12MetaStats getStats() {
    return stats;
  }

  public void setStats(@javax.annotation.Nullable InlineObject12MetaStats stats) {
    this.stats = stats;
  }


  public InlineObject12Meta publicId(@javax.annotation.Nullable String publicId) {
  ...
  public boolean equals(Object o) {
    ...
    InlineObject12Meta inlineObject12Meta = (InlineObject12Meta) o;
    return Objects.equals(this.name, inlineObject12Meta.name) &&
        Objects.equals(this.displayName, inlineObject12Meta.displayName) &&
        Objects.equals(this.encoding, inlineObject12Meta.encoding) &&
        Objects.equals(this.contentType, inlineObject12Meta.contentType) &&
        Objects.equals(this.stats, inlineObject12Meta.stats) &&
        Objects.equals(this.publicId, inlineObject12Meta.publicId);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "display_name", "encoding", "content-type", "stats", "public_id"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject12Meta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject12Meta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineObject12Meta is not found in the empty JSON string", InlineObject12Meta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject12Meta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject12Meta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("stats") != null && !jsonObj.get("stats").isJsonNull()) {
        InlineObject12MetaStats.validateJsonElement(jsonObj.get("stats"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineObject12Meta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineObject12Meta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineObject12Meta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineObject12Meta.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineObject12Meta>() {
           @Override
           public void write(JsonWriter out, InlineObject12Meta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineObject12Meta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineObject12Meta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineObject12Meta
   * @throws IOException if the JSON string is invalid with respect to InlineObject12Meta
   */
  public static InlineObject12Meta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineObject12Meta.class);
  }

  /**
   * Convert an instance of InlineObject12Meta to an JSON string
   *
   * @return JSON string
   */
