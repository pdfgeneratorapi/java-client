...
import com.pdfgeneratorapi.client.model.PaginationMeta;
...
public class InlineObject6 {
  ...
  public InlineObject6 response(@javax.annotation.Nullable List<FormConfiguration> response) {
    this.response = response;
    return this;
  }

  public InlineObject6 addResponseItem(FormConfiguration responseItem) {
  ...
  public InlineObject6 meta(@javax.annotation.Nullable PaginationMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, inlineObject6.response) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject6
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject6.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject6.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject6` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
