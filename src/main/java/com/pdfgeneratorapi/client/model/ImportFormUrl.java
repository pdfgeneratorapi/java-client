...
public class ImportFormUrl {
  ...
  public ImportFormUrl() {
  }

  public ImportFormUrl fileUrl(@javax.annotation.Nonnull String fileUrl) {
  ...
  public ImportFormUrl form(@javax.annotation.Nullable FormConfigurationNew form) {
    this.form = form;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportFormUrl importFormUrl = (ImportFormUrl) o;
    return Objects.equals(this.fileUrl, importFormUrl.fileUrl) &&
        Objects.equals(this.form, importFormUrl.form);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileUrl, form);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("file_url", "form"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportFormUrl
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportFormUrl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportFormUrl is not found in the empty JSON string", ImportFormUrl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportFormUrl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportFormUrl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportFormUrl.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportFormUrl.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportFormUrl' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportFormUrl> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportFormUrl.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportFormUrl>() {
           @Override
           public void write(JsonWriter out, ImportFormUrl value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportFormUrl read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportFormUrl given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportFormUrl
   * @throws IOException if the JSON string is invalid with respect to ImportFormUrl
   */
  public static ImportFormUrl fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportFormUrl.class);
  }

  /**
   * Convert an instance of ImportFormUrl to an JSON string
   *
   * @return JSON string
   */
