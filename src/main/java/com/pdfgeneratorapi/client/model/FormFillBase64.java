...
public class FormFillBase64 {
  ...
  public FormFillBase64() {
  }

  public FormFillBase64 fileBase64(@javax.annotation.Nonnull String fileBase64) {
  ...
  public FormFillBase64 data(@javax.annotation.Nonnull Object data) {
    this.data = data;
    return this;
  }
  ...
  public FormFillBase64 output(@javax.annotation.Nullable OutputEnum output) {
    this.output = output;
    return this;
  }
  ...
  public FormFillBase64 name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FormFillBase64 formFillBase64 = (FormFillBase64) o;
    return Objects.equals(this.fileBase64, formFillBase64.fileBase64) &&
        Objects.equals(this.data, formFillBase64.data) &&
        Objects.equals(this.output, formFillBase64.output) &&
        Objects.equals(this.name, formFillBase64.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileBase64, data, output, name);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("file_base64", "data", "output", "name"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("file_base64", "data"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FormFillBase64
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FormFillBase64.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormFillBase64 is not found in the empty JSON string", FormFillBase64.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FormFillBase64.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FormFillBase64` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FormFillBase64.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormFillBase64.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormFillBase64' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormFillBase64> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormFillBase64.class));

       return (TypeAdapter<T>) new TypeAdapter<FormFillBase64>() {
           @Override
           public void write(JsonWriter out, FormFillBase64 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FormFillBase64 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FormFillBase64 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FormFillBase64
   * @throws IOException if the JSON string is invalid with respect to FormFillBase64
   */
  public static FormFillBase64 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormFillBase64.class);
  }

  /**
   * Convert an instance of FormFillBase64 to an JSON string
   *
   * @return JSON string
   */
