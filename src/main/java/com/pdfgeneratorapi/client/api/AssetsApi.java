...
import com.pdfgeneratorapi.client.model.GenerateQRCode201Response;
import com.pdfgeneratorapi.client.model.GenerateQRCodeRequest;
...
public class AssetsApi {
     ...
     * @param generateQRCodeRequest QR Code configuration (required)
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 201 </td><td> QR code response </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call generateQRCodeCall(@javax.annotation.Nonnull GenerateQRCodeRequest generateQRCodeRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = generateQRCodeRequest;

        // create path and map variables
        String localVarPath = "/assets/qrcode";
    ...
    private okhttp3.Call generateQRCodeValidateBeforeCall(@javax.annotation.Nonnull GenerateQRCodeRequest generateQRCodeRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'generateQRCodeRequest' is set
        if (generateQRCodeRequest == null) {
            throw new ApiException("Missing the required parameter 'generateQRCodeRequest' when calling generateQRCode(Async)");
        }

        return generateQRCodeCall(generateQRCodeRequest, _callback);
     ...
     */
    public GenerateQRCode201Response generateQRCode(@javax.annotation.Nonnull GenerateQRCodeRequest generateQRCodeRequest) throws ApiException {
        ApiResponse<GenerateQRCode201Response> localVarResp = generateQRCodeWithHttpInfo(generateQRCodeRequest);
     ...
     * Creates a QR code based on the configuration
     * @param generateQRCodeRequest QR Code configuration (required)
     * @return ApiResponse&lt;GenerateQRCode201Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<GenerateQRCode201Response> generateQRCodeWithHttpInfo(@javax.annotation.Nonnull GenerateQRCodeRequest generateQRCodeRequest) throws ApiException {
        okhttp3.Call localVarCall = generateQRCodeValidateBeforeCall(generateQRCodeRequest, null);
        Type localVarReturnType = new TypeToken<GenerateQRCode201Response>(){}.getType();
     ...
     */
    public okhttp3.Call generateQRCodeAsync(@javax.annotation.Nonnull GenerateQRCodeRequest generateQRCodeRequest, final ApiCallback<GenerateQRCode201Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = generateQRCodeValidateBeforeCall(generateQRCodeRequest, _callback);
        Type localVarReturnType = new TypeToken<GenerateQRCode201Response>(){}.getType();
