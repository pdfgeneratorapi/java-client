...
import com.pdfgeneratorapi.client.model.GenerateDocumentAsynchronousRequest;
import com.pdfgeneratorapi.client.model.GenerateDocumentBatchAsynchronousRequest;
import com.pdfgeneratorapi.client.model.GenerateDocumentBatchRequest;
import com.pdfgeneratorapi.client.model.GenerateDocumentRequest;
import com.pdfgeneratorapi.client.model.GenerateViewerUrl200Response;
import com.pdfgeneratorapi.client.model.GenerateViewerUrlRequest;
import com.pdfgeneratorapi.client.model.InlineObject11;
import com.pdfgeneratorapi.client.model.InlineObject13;
...
public class DocumentsApi {
    ...
    /**
     * Build call for generateViewerUrl
     * @param publicId Resource public id (required)
     * @param generateViewerUrlRequest Optional response format and viewer prefill data. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Viewer URL response, returned when &#x60;output&#x60; is &#x60;viewer&#x60;. </td><td>  -  </td></tr>
        <tr><td> 201 </td><td> Document data </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
        <tr><td> 402 </td><td> Account Suspended </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call generateViewerUrlCall(@javax.annotation.Nonnull String publicId, @javax.annotation.Nullable GenerateViewerUrlRequest generateViewerUrlRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = generateViewerUrlRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call generateViewerUrlValidateBeforeCall(@javax.annotation.Nonnull String publicId, @javax.annotation.Nullable GenerateViewerUrlRequest generateViewerUrlRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'publicId' is set
        if (publicId == null) {
            throw new ApiException("Missing the required parameter 'publicId' when calling generateViewerUrl(Async)");
        }

        return generateViewerUrlCall(publicId, generateViewerUrlRequest, _callback);
     ...
     */
    public GenerateViewerUrl200Response generateViewerUrl(@javax.annotation.Nonnull String publicId, @javax.annotation.Nullable GenerateViewerUrlRequest generateViewerUrlRequest) throws ApiException {
        ApiResponse<GenerateViewerUrl200Response> localVarResp = generateViewerUrlWithHttpInfo(publicId, generateViewerUrlRequest);
        return localVarResp.getData();
    }
     ...
     * @param publicId Resource public id (required)
     * @param generateViewerUrlRequest Optional response format and viewer prefill data. (optional)
     * @return ApiResponse&lt;GenerateViewerUrl200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<GenerateViewerUrl200Response> generateViewerUrlWithHttpInfo(@javax.annotation.Nonnull String publicId, @javax.annotation.Nullable GenerateViewerUrlRequest generateViewerUrlRequest) throws ApiException {
        okhttp3.Call localVarCall = generateViewerUrlValidateBeforeCall(publicId, generateViewerUrlRequest, null);
        Type localVarReturnType = new TypeToken<GenerateViewerUrl200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get document with prefill (asynchronously)
     * Returns a URL for a stored document, optionally with viewer prefill data. The prefill is encrypted server-side and embedded in the viewer URL, so the caller does not have to handle encryption. Prefill is only applied when &#x60;output&#x60; is &#x60;viewer&#x60;. 
     * @param publicId Resource public id (required)
     * @param generateViewerUrlRequest Optional response format and viewer prefill data. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call generateViewerUrlAsync(@javax.annotation.Nonnull String publicId, @javax.annotation.Nullable GenerateViewerUrlRequest generateViewerUrlRequest, final ApiCallback<GenerateViewerUrl200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = generateViewerUrlValidateBeforeCall(publicId, generateViewerUrlRequest, _callback);
        Type localVarReturnType = new TypeToken<GenerateViewerUrl200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A list of document actions </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
        <tr><td> 402 </td><td> Account Suspended </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Not Found </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call getDocumentActionsCall(@javax.annotation.Nonnull String publicId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/documents/{publicId}/actions"
            .replace("{" + "publicId" + "}", localVarApiClient.escapeString(publicId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDocumentActionsValidateBeforeCall(@javax.annotation.Nonnull String publicId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'publicId' is set
        if (publicId == null) {
            throw new ApiException("Missing the required parameter 'publicId' when calling getDocumentActions(Async)");
        }

        return getDocumentActionsCall(publicId, _callback);
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A list of document versions </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
        <tr><td> 402 </td><td> Account Suspended </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Not Found </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call getDocumentVersionsCall(@javax.annotation.Nonnull String publicId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/documents/{publicId}/versions"
            .replace("{" + "publicId" + "}", localVarApiClient.escapeString(publicId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDocumentVersionsValidateBeforeCall(@javax.annotation.Nonnull String publicId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'publicId' is set
        if (publicId == null) {
            throw new ApiException("Missing the required parameter 'publicId' when calling getDocumentVersions(Async)");
        }

        return getDocumentVersionsCall(publicId, _callback);
     ...
     */
    public InlineObject16 getDocumentVersions(@javax.annotation.Nonnull String publicId) throws ApiException {
        ApiResponse<InlineObject16> localVarResp = getDocumentVersionsWithHttpInfo(publicId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InlineObject16> getDocumentVersionsWithHttpInfo(@javax.annotation.Nonnull String publicId) throws ApiException {
        okhttp3.Call localVarCall = getDocumentVersionsValidateBeforeCall(publicId, null);
        Type localVarReturnType = new TypeToken<InlineObject16>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get document versions (asynchronously)
     * Returns a list of versions for a stored document
     * @param publicId Resource public id (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getDocumentVersionsAsync(@javax.annotation.Nonnull String publicId, final ApiCallback<InlineObject16> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDocumentVersionsValidateBeforeCall(publicId, _callback);
        Type localVarReturnType = new TypeToken<InlineObject16>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
